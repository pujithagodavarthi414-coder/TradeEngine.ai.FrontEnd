...
@Component({
  selector: 'app-form-view-component',
...
export class ViewsFormComponent implements OnInit {
  ...
  form: any;
  formName: any;
  constructor( public cdRef: ChangeDetectorRef, private cookieService: CookieService, private formCreationService: FormCreationService) {
  ...
  ngOnInit() { 
    var test = "test";
    this.getFormDetails('2ba72d84-7df1-4142-ad07-b61ceb4cfdca');
  }
  getFormDetails(id) {
