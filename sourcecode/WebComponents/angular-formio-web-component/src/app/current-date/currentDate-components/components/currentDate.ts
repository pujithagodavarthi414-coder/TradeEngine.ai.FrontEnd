...
export default class UniqueDateTimeComponent extends (FieldComponent as any)  {
  ...
  static schema(...extend) {
    return FieldComponent.schema({
      ...
      defaultValue: '',
      defaultDate:'',
      customDefaultValue: "value = moment().format()",
      disabled: true,
  ...
  static get builderInfo() {
    return {
      title: 'Unique Date / Time',
      group: 'advanced',
      icon: 'calendar',
      documentation: '/userguide/#datetime',
      weight: 40,
      schema: UniqueDateTimeComponent.schema()
    };
  }
  ...
  get defaultSchema() {
    return UniqueDateTimeComponent.schema();
  }
