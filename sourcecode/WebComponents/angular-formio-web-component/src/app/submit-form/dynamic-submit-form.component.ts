...
@Component({
  selector: 'app-dynamic-submit-form-component',
  templateUrl: './dynamic-submit-form.component.html'
})
export class DynamicSubmitFormComponent implements OnInit{
  submittedData: any;
  ...
  ngOnInit() {
    console.log('entered dynamic submit form auth ngOnInit');
    ...
    {
     console.log('in ca', customApplicationId);
    this.customApplicationsLoaded = false;
    this.customApplicationId = customApplicationId;
    this.formIds = formId;
    this.getCustomApplication(customApplicationId, this.formIds);
    }
  }
  ...
  getFormSubmitted(data) {
    ...
    this.formCreationService
      .GetLatestSubmittedReportByFormId(this.customApplicationId, this.formIds,   null,   false,  1,  1,null,  null,  null,  null, null,  null)
