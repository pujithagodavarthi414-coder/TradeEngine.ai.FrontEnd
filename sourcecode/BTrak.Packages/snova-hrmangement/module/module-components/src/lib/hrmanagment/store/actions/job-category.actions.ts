...
export enum JobCategoryActionTypes {
    LoadJobCategoryTriggered = '[HR Widgets Job Category Component] Initial Data Load Triggered',
    LoadJobCategoryCompleted = '[HR Widgets Job Category Component] Initial Data Load Completed',
    LoadJobCategoryFailed = '[HR Widgets Job Category Component] Initial Data Load Failed',
    ExceptionHandled = '[HR Widgets Job Category Component] Handle Exception',
}
