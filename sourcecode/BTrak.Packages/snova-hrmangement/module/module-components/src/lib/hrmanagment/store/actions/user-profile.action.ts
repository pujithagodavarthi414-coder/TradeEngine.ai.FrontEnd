...
export enum UserProfileActionTypes {
    GetUserProfileByIdTriggered = '[HR Widgets User Profile Details Component] Get User Profile Details By Id Triggered',
    GetUserProfileByIdCompleted = '[HR Widgets User Profile Details Component] Get User Profile Details By Id Completed',
    GetUserProfileByIdFailed = '[HR Widgets User Profile Details Component] Get User Profile Details By Id Failed',
    // CreateProfileImageTriggered = '[User Profile Details Component] Create User Profile Details Triggered',
    // CreateProfileImageCompleted = '[User Profile Details Component] Create User Profile Details Completed',
    // CreateProfileImageFailed = '[User Profile Details Component] Create User Profile Details Failed',
    // UpdateProfileImageById = '[User Profile Details Component] Update User Profile Details By Id',
    // UserIsViewingOthersProfile = '[User Profile Details Component] User Is Viewing Others Profile',
    ExceptionHandled = '[HR Widgets User Profile Details Component] Handle Exception',
}
