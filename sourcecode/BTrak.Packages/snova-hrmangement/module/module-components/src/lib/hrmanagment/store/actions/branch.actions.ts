...
export enum BranchActionTypes {
    LoadBranchTriggered = '[HR Widgets Branch Component] Initial Data Load Triggered',
    LoadBranchCompleted = '[HR Widgets Branch  Component] Initial Data Load Completed',
    LoadBranchFailed = '[HR Widgets Branch  Component] Initial Data Load Failed',
    ExceptionHandled = '[HR Widgets Branch Component] HandleException',
}
