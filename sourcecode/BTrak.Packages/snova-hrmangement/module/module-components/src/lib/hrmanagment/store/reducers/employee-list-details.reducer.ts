...
export const AllEmployeeListAdapter: EntityAdapter<
    EmployeeListModel
> = createEntityAdapter<EmployeeListModel>({
    selectId: (employee: EmployeeListModel) => employee.employeeId
});

export const initialState: State = AllEmployeeListAdapter.getInitialState({
...
export function reducer(
    ...
    switch (action.type) {
        case EmployeeListActionTypes.LoadAllEmployeeDetailsListItemsTriggered:
            return { ...state, loadingEmployeeList: true };
        case EmployeeListActionTypes.LoadAllEmployeeDetailsListItemsCompleted:
            return AllEmployeeListAdapter.addAll(action.employeeDetailsList, {
                ...state,
                loadingEmployeeList: false
            });
        ...
        //     return AllEmployeeListAdapter.upsertOne(action.employee, state);
        // case EmployeeListActionTypes.ExceptionHandled:
