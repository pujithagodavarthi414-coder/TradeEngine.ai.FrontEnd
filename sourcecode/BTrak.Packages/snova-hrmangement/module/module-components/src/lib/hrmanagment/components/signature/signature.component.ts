...
export class SignatureComponent extends CustomAppBaseComponent implements OnInit {
    ...
    constructor(private hrManagementService: HRManagementService, private employeeService: EmployeeService,
    ...
    public submit() {
        ...
        this.employeeService.UploadFile(formData, this.moduleTypeId).subscribe((result: any) => {
