...
export enum EmployeeListActionTypes {
    LoadEmployeeListItemsTriggered = '[HR Widgets Employee List Component] Initial Data Load Triggered',
    LoadEmployeeListItemsCompleted = '[HR Widgets Employee List Component] Initial Data Load Completed',
    LoadEmployeeListItemsDetailsFailed = '[HR Widgets Employee List Component] Initial Data Load Failed',
    CreateEmployeeListItemTriggered = '[HR Widgets Employee List Component] Create Employee ListTriggered',
    CreateEmployeeListItemCompleted = '[HR Widgets Employee List Component] Create Employee List Completed',
    CreateEmployeeListItemFailed = '[HR Widgets Employee List Component] Create Employee List Failed',
    GetEmployeeListDetailsByIdTriggered = '[HR Widgets Employee List Details Component] Get Employee List Details By Id Triggered',
    GetEmployeeListDetailsByIdCompleted = '[HR Widgets Employee List Details Component] Get Employee List Details By Id Completed',
    GetEmployeeListDetailsByIdFailed = '[HR Widgets Employee List Details Component] Get Employee List Details By Id Failed',
    UpdateEmployeeListDetailsById = '[HR Widgets Employee List Details Component] Update Employee List Details By Id',
    RefreshEmployeeListDetailsList = '[HR Widgets Employee List Details Component] Refresh Employee List Details List',
    ExceptionHandled = '[HR Widgets Employee List Component] Handle Exception',
    LoadAllEmployeeDetailsListItemsTriggered = "[HR Widgets Employee List Component] Initial All Employee Load Triggered",
    LoadAllEmployeeDetailsListItemsCompleted = "[HR Widgets Employee List Component] Initial All Employee Load Completed"
}
