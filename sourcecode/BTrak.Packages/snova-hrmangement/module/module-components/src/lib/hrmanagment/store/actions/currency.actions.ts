...
export enum CurrencyActionTypes {
    LoadCurrencyTriggered = '[HR Widgets Currency Component] Initial Data Load Triggered',
    LoadCurrencyCompleted = '[HR Widgets Currency  Component] Initial Data Load Completed',
    LoadCurrencyFailed = '[HR Widgets Currency  Component] Initial Data Load Failed',
    ExceptionHandled = '[HR Widgets Currency Component] HandleException',
}
