...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[HR Widgets softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[HR Widgets softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[HR Widgets softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[HR Widgets softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[HR Widgets softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[HR Widgets softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[HR Widgets softLabel Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[HR Widgets  Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[HR Widgets softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[HR Widgets softLabel Component] Update softLabel Field",
}
