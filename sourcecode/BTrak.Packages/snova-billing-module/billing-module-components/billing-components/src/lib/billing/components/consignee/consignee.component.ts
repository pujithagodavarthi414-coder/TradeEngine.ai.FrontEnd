...
@Component({
    selector: "app-consignee-component",
    templateUrl: "consignee.component.html"
})

export class ConsigneeComponent extends AppBaseComponent implements OnInit {
    ...
    editConsignee(rowDetails, consigneePopup) {
        ...
        this.consignee = this.translateService.instant("CONSIGNEE.EDITCONSIGNEE");
    ...
    createConsignee(consigneePopup) {
        consigneePopup.openPopover();
        this.consignee = this.translateService.instant("CONSIGNEE.ADDCONSIGNEE");
    }
    ...
    upsertConsignee(formDirective: FormGroupDirective) {
        ...
        this.BillingDashboardService.upsertConsignees(consignee).subscribe((response: any) => {
    ...
    deleteConsignee() {
        ...
        this.BillingDashboardService.upsertConsignees(ConsigneesModel).subscribe((response: any) => {
            if (response.success === true) {
                this.deleteConsigneePopup.forEach((p) => p.closePopover());
                this.clearForm();
                this.getAllConsignees();
