...
import { SoftLabelModel } from '../models/soft-label-model';
...
import { PeakHourModel } from '../models/peakhour-model';
import { RateSheetModel } from '../models/ratesheet-model';
import { RateSheetForModel } from '../models/ratesheet-for-model';
import { ProfessionalTaxRanges } from '../models/professional-tax-ranges-model';
import { TaxSlabs } from '../models/tax-slabs-model';
...
import { ReportingMethodModel } from '../models/reporting-method-model';
import { PaymentTypeUpsertModel } from '../models/paymenttype-model';
