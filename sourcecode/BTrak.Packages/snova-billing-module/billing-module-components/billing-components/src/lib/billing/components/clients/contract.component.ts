...
@Component({
    selector: "app-billing-component-contract",
    templateUrl: "contract.component.html"
})

export class ContractComponent extends AppBaseComponent implements OnInit {
    ...
    constructor(private BillingDashboardService: BillingDashboardService,
        private translateService: TranslateService, @Inject(MAT_DIALOG_DATA) public data: DialogData, private toastr: ToastrService, public dialogRef: MatDialogRef<ContractComponent>,
