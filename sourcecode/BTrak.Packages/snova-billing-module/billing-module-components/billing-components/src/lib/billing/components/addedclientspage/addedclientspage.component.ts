...
export class AddedclientspageComponent implements OnInit {
  ...
  constructor(private BillingDashboardService: BillingDashboardService, private cd: ChangeDetectorRef, private activatedRoute: ActivatedRoute, public dialog: MatDialog, private hrdashboardservice: HrDashboardService) { }
  ngOnInit() {
