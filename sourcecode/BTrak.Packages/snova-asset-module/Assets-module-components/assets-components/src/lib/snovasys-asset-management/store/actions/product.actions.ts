...
export enum ProductActionTypes {
    LoadProductsTriggered = '[Asset Management Product Component] Initial Data Load Triggered',
    LoadProductsCompleted = '[Asset Management Product Component] Initial Data Load Completed',
    LoadProductsFailed = '[Asset Management Product Component] Initial Data Load Failed',
    CreateProductTriggered = '[Asset Management Product Component] Create Product Triggered',
    CreateProductCompleted = '[Asset Management Product Component] Create Product Completed',
    CreateProductFailed = '[Asset Management Product Component] Create Product Failed',
    ProductExceptionHandled = '[Asset Management Product Component] HandleException',
}
