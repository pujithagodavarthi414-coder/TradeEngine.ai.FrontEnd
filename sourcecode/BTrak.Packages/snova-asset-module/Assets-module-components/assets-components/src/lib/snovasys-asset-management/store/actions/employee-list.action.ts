...
export enum EmployeeListActionTypes {
    LoadEmployeeListItemsTriggered = '[Asset Management Employee List Component] Initial Data Load Triggered',
    LoadEmployeeListItemsCompleted = '[Asset Management Employee List Component] Initial Data Load Completed',
    LoadEmployeeListItemsDetailsFailed = '[Asset Management Employee List Component] Initial Data Load Failed',
    CreateEmployeeListItemTriggered = '[Asset Management Employee List Component] Create Employee ListTriggered',
    CreateEmployeeListItemCompleted = '[Asset Management Employee List Component] Create Employee List Completed',
    CreateEmployeeListItemFailed = '[Asset Management Employee List Component] Create Employee List Failed',
    GetEmployeeListDetailsByIdTriggered = '[Asset Management Employee List Details Component] Get Employee List Details By Id Triggered',
    GetEmployeeListDetailsByIdCompleted = '[Asset Management Employee List Details Component] Get Employee List Details By Id Completed',
    GetEmployeeListDetailsByIdFailed = '[Asset Management Employee List Details Component] Get Employee List Details By Id Failed',
    UpdateEmployeeListDetailsById = '[Asset Management Employee List Details Component] Update Employee List Details By Id',
    RefreshEmployeeListDetailsList = '[Asset Management Employee List Details Component] Refresh Employee List Details List',
    EmployeeListExceptionHandled = '[Asset Management Employee List Component] Handle Exception',
    LoadAllEmployeeDetailsListItemsTriggered = "[Asset Management Employee List Component] Initial All Employee Load Triggered",
    LoadAllEmployeeDetailsListItemsCompleted = "[Asset Management Employee List Component] Initial All Employee Load Completed"
}
