...
export enum DamagedAssetsActionTypes {
    LoadRecentlyDamagedAssetsTriggered = '[Asset Management Recently Damaged Assets Component] Initial Data Load Triggered',
    LoadRecentlyDamagedAssetsCompleted = '[Asset Management Recently Damaged Assets Component] Initial Data Load Completed',
    LoadRecentlyDamagedAssetsFailed = '[Asset Management Recently Damaged Assets Component] Initial Data Load Failed',
    DamagedAssetsExceptionHandled = '[Asset Management Recently Damaged Assets Component] HandleException',
}
