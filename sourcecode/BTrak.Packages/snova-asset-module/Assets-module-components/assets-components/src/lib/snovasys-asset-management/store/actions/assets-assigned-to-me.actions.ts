...
export enum AssetsAllocatedToMeActionTypes {
    LoadAssetsAllocatedToMeTriggered = '[Asset Management Assets Allocated To Me Component] Initial Data Load Triggered',
    LoadAssetsAllocatedToMeCompleted = '[Asset Management Assets Allocated To Me Component] Initial Data Load Completed',
    LoadAssetsAllocatedToMeFailed = '[Asset Management Assets Allocated To Me Component] Initial Data Load Failed',
    ExceptionHandled = '[Asset Management Assets Allocated To Me Component] HandleException',
}
