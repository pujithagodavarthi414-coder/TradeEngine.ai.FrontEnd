...
export enum LocationActionTypes {
    LoadLocationsTriggered = '[Asset Management Location Component] Initial Data Load Triggered',
    LoadLocationsCompleted = '[Asset Management Location Component] Initial Data Load Completed',
    LoadLocationsFailed = '[Asset Management Location Component] Initial Data Load Failed',
    CreateLocationTriggered = '[Asset Management Location Component] Create Location Triggered',
    CreateLocationCompleted = '[Asset Management Location Component] Create Location Completed',
    CreateLocationFailed = '[Asset Management Location Component] Create Location Failed',
    GetLocationsByIdTriggered = '[Asset Management location Component] Get location By Id Triggered',
    GetLocationsByIdCompleted = '[Asset Management location Component] Get location By Id Completed',
    GetLocationsByIdFailed = '[Asset Management location Component] Get location By Id Failed',
    DeleteLocationsCompleted = '[Asset Management location Component] Delete location Completed',
    UpdateLocationsById = '[Asset Management location Component] Update location By Id',
    RefreshLocations = '[Asset Management location Component] Refresh location List',
    LocationExceptionHandled = '[Asset Management Location Component] HandleException',
}
...
export class LocationExceptionHandled implements Action {
    type = LocationActionTypes.LocationExceptionHandled;
    locationSearchResult: LocationManagement;
    seatingLocations: LocationManagement[];
    location: LocationManagement;
    locationsUpdates: { LocationsUpdate: Update<LocationManagement> }
