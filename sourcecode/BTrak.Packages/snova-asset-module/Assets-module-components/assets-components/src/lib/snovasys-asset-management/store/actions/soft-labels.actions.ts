...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[Asset Management softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[Asset Management softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[Asset Management softLabel Component] Upsert softLabel Failed",
    SoftLabelExceptionHandled = "[Asset Management softLabel Component] SoftLabelExceptionHandled",
    GetsoftLabelsTriggered = "[Asset Management softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[Asset Management softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[Asset Management softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[Asset Management softLabel Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[Asset Management softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[Asset Management softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[Asset Management softLabel Component] Update softLabel Field",
}
