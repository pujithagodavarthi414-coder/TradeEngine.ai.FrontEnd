...
export enum BranchActionTypes {
    LoadBranchTriggered = '[Asset Management Branch Component] Initial Data Load Triggered',
    LoadBranchCompleted = '[Asset Management Branch  Component] Initial Data Load Completed',
    LoadBranchFailed = '[Asset Management Branch  Component] Initial Data Load Failed',
    BranchExceptionHandled = '[Asset Management Branch Component] HandleException',
}
