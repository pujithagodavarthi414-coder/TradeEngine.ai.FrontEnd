...
export enum AssetsActionTypes {
    LoadAssetsTriggered = '[Asset Management Assets Component] Initial Data Load Triggered',
    LoadAssetsCompleted = '[Asset Management Assets Component] Initial Data Load Completed',
    LoadAssetsFailed = '[Asset Management Assets Component] Initial Data Load Failed',
    CreateAssetsTriggered = '[Asset Management Assets Component] Create Asset Triggered',
    CreateAssetsCompleted = '[Asset Management Assets Component] Create Asset Completed',
    CreateAssetsFailed = '[Asset Management Assets Component] Create Asset Failed',
    GetAssetByIdTriggered = '[Asset Management Assets Component] Get Asset By Id Triggered',
    GetAssetByIdCompleted = '[Asset Management Assets Component] Get Asset By Id Completed',
    GetAssetByIdFailed = '[Asset Management Assets Component] Get Asset By Id Failed',
    CreateAssetCompletedWithInPlaceUpdate = '[Asset Management Asset Component] Create Asset Completed With InPlace Update',
    RefreshAssetsList = '[Asset Management Asset Component] Refresh Assets List',
    RemoveAssetsFromTheList = '[Asset Management Asset Component] Asset To Be Removed',
    GetSelectedAssetTriggered = '[Asset Management Asset Component] Get Selected Asset Triggered',
    GetSelectedAssetCompleted = '[Asset Management Asset Component] Get Selected Asset Completed',
    AssetsTotalCountTriggered = '[Asset Management Asset Component] Assets Total Count Triggered',
    AssetsTotalCountCompleted = '[Asset Management Asset Component] Assets Total Count Completed',
    GetAssetsByIdsTriggered = '[Asset Management] Assets Load By Ids Triggered',
    GetAssetsByIdsCompleted = '[Asset Management] Assets Load By Ids Completed',
    GetAssetsByIdsFailed = '[Asset Management] Assets Load By Ids Failed',
    AssetsExceptionHandled = '[Asset Management Assets Component] HandleException',
    RemoveMultipleAssetsIdsCompleted = "[Asset Management Assets Component] Remove Multiple Assets Ids Completed",
    LoadAssetsCommentsAndHistory = "[Asset Management Assets Component] Load Assets Comments and history",
}
...
export class AssetsExceptionHandled implements Action {
    type = AssetsActionTypes.AssetsExceptionHandled;
    assetsSearchResult: AssetInputModel;
    assetsList: Assets[];
    asset: Assets;
    assetId: string;
