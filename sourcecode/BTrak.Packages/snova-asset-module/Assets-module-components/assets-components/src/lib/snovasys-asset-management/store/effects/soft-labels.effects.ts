...
import { UpsertsoftLabelTriggered, softLabelsActionTypes, UpsertsoftLabelCompleted, UpsertsoftLabelFailed, SoftLabelExceptionHandled, GetsoftLabelsTriggered, GetsoftLabelsCompleted, GetsoftLabelsFailed, GetsoftLabelByIdTriggered, GetsoftLabelByIdCompleted, GetsoftLabelByIdFailed, UpdatesoftLabelField } from "../actions/soft-labels.actions";
...
export class SoftLabelConfigurationEffects {
        ...
        switchMap(action => {
            return this.assetService
                ...
                .pipe(map((response: any) => {
                    ...
                    catchError(error => {
                        return of(new SoftLabelExceptionHandled(error));
                    })
                );
        })
    );
    ...
    @Effect()
    SoftLabelExceptionHandled$: Observable<Action> = this.actions$.pipe(
        ofType<SoftLabelExceptionHandled>(softLabelsActionTypes.SoftLabelExceptionHandled),
        switchMap(searchAction => {
