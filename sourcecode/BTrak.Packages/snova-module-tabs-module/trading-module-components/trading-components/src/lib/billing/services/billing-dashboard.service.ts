...
export class BillingDashboardService {
  ...
  getMappingUserInstance(model: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(model);
    return this.http
      .post(APIEndpoint + ApiUrls.GetMappingUserInstance, body, httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
  ...
  // template configration apis
  getTemplateConfigrations(tradeTemplateModel: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(tradeTemplateModel);
    return this.http
      .post(APIEndpoint + 'Lives/LivesApi/GetApicalTemplate', body,  httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
  getTemplateConfigrationTypes(templateConfigModel: TemplateConfigModel) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(templateConfigModel);
    return this.http
      .post(APIEndpoint + `Lives/LivesApi/GetApicalTemplateTypes`, body, httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
  upsertConfigrationTemplate(tradeTemplateModel: TradeTemplateModel) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(tradeTemplateModel);
    return this.http
      .post(APIEndpoint + `Lives/LivesApi/UpsertApicalTemplate`, body, httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
  getApicalTemplateProgramOwnerConfiguration(tradeTemplateModel: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(tradeTemplateModel);
    return this.http
      .post(APIEndpoint + 'Lives/LivesApi/GetApicalTemplateProgramOwnerConfiguration', body,  httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
  upsertApicalTemplateProgramOwnerConfiguration(tradeTemplateModel: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(tradeTemplateModel);
    return this.http
      .post(APIEndpoint + `Lives/LivesApi/UpsertApicalTemplateProgramOwnerConfiguration`, body, httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }

  getGenericFormKey(model: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(model);
    return this.http
      .post(APIEndpoint + ApiUrls.GetGenericFormKey, body, httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }

  getProgramProgressDetails(tradeTemplateModel: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(tradeTemplateModel);
    return this.http
      .post(APIEndpoint + 'Lives/LivesApi/GetProgramProgressDetails', body,  httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
  upsertProgramProgressDetails(tradeTemplateModel: any) {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-Type": "application/json" }),
    };
    let body = JSON.stringify(tradeTemplateModel);
    return this.http
      .post(APIEndpoint + `Lives/LivesApi/UpsertProgramProgressDetails`, body, httpOptions)
      .pipe(map(result => {
        return result;
      }));
  }
