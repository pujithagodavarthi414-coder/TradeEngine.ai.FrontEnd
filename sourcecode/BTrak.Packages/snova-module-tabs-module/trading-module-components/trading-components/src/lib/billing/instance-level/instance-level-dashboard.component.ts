...
@Component({
    selector: 'app-instance-level-dashboard',
    templateUrl: './instance-level-dashboard.component.html',
    styleUrls: ['./instance-level-dashboard.component.scss']
})

export class InstanceLevelDashboard implements OnInit {
    @Input("productGroup")
    ...
    getDataList() {
        ...
        searchModel.isConsolidated = false;
        this.isLoadingInprogress = true;
        this.dashboardService.getInstanceLevelDashboard(searchModel).subscribe((response: any) => {
    ...
    getProfitAndLossBasedOnInstanceLevel() {
        ...
        this.dashboardService.getProfitLossListBasedOnInstance(searchModel).subscribe((response: any) => {
