...
export enum CurrencyActionTypes {
    LoadCurrencyTriggered = '[Canteen Currency Component] Initial Data Load Triggered',
    LoadCurrencyCompleted = '[Canteen Currency  Component] Initial Data Load Completed',
    LoadCurrencyFailed = '[Canteen Currency  Component] Initial Data Load Failed',
    ExceptionHandled = '[Canteen Currency Component] HandleException',
}
