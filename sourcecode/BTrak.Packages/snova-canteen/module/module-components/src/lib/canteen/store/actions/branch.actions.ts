...
export enum BranchActionTypes {
    LoadBranchTriggered = '[Canteen Branch Component] Initial Data Load Triggered',
    LoadBranchCompleted = '[Canteen Branch  Component] Initial Data Load Completed',
    LoadBranchFailed = '[Canteen Branch  Component] Initial Data Load Failed',
    ExceptionHandled = '[Canteen Branch Component] HandleException',
}
