...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[Canteen softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[Canteen softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[Canteen softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[Canteen softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[Canteen softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[Canteen softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[Canteen softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[Canteen softLabel Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[Canteen softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[Canteen softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[Canteen softLabel Component] Update softLabel Field",
}
