...
import { LoadUsersDropDownTriggered, UsersActionTypes, LoadUsersDropDownCompleted, LoadUsersDropDownFailed, UsersExceptionHandled } from "../actions/users.actions";
...
export class UsersEffects {
        ...
        switchMap(searchAction => {
            return this.userService
                ...
                .pipe(
                    ...
                    catchError(error => {
                        return of(new UsersExceptionHandled(error));
                    })
                );
        })
    );
    ...
    exceptionHandledForLoadUsersDropDown$: Observable<Action> = this.actions$.pipe(
        ofType<UsersExceptionHandled>(UsersActionTypes.UsersExceptionHandled),
        switchMap(searchAction => {
    ...
    constructor(
        ...
        private userService: CanteenManagementService
    ) { }
}