...
@Component({
    selector: 'app-reports-and-settings',
    templateUrl:`area-reports-settings-component.html`
})
export class ExpenseReportsAndSettingsComponent extends AppBaseComponent  implements OnInit {
    ...
    constructor(
        ...
        private expenseModulesService: ExpenseModulesService,
    ...
    loadComponent() {
       ...
       // var module = _.find(modules, function(module){ return module.modulePackageName == 'WidgetPackageModule' });
        ...
        //         );
           ...
           var loader = this.expenseModulesService["modules"];
