import { ExpenseModuleInfo } from 'billing-module-components/billing-components/src/lib/expensemanagement/models/ExpenseModuleInfo';

export const info: ExpenseModuleInfo = {
    modules:[
        {
