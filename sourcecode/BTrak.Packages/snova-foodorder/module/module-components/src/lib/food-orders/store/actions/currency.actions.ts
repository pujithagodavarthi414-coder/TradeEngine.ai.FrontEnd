...
export enum CurrencyActionTypes {
    LoadCurrencyTriggered = '[Food Order Currency Component] Initial Data Load Triggered',
    LoadCurrencyCompleted = '[Food Order Currency  Component] Initial Data Load Completed',
    LoadCurrencyFailed = '[Food Order Currency  Component] Initial Data Load Failed',
    ExceptionHandled = '[Food Order Currency Component] HandleException',
}
