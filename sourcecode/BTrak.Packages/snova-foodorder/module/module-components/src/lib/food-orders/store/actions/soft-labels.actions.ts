...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[Food Order softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[Food Order softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[Food Order softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[Food Order softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[Food Order softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[Food Order softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[Food Order softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[Food Order  Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[Food Order softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[Food Order softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[Food Order softLabel Component] Update softLabel Field",
}
