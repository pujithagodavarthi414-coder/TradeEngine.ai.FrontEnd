...
export enum StoreConfigurationActionTypes {
    LoadStoreConfigurationsTriggered = '[Food Order Store Configuration Component] Initial Data Load Triggered',
    LoadStoreConfigurationsCompleted = '[Food Order Store Configuration Component] Initial Data Load Completed',
    LoadStoreConfigurationsFailed = '[Food Order Store Configuration Component] Initial Data Load Failed',
    ExceptionHandled = '[Food Order Store Configuration Component] Handle Exception',
}
