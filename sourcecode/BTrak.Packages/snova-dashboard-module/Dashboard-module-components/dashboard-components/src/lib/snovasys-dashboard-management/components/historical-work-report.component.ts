...
export class EmployeeHistoricalWorkReportComponent extends CustomAppBaseComponent implements OnInit {
  ...
  constructor(
    ...
    private statusReportService: StatusreportService, private softLabelsPipe: SoftLabelPipe
  ) {
    super();
  ...
  getExcelColumnList(){
    var returnList = [];
      returnList.push({ExcelColumn : this.translateService.instant('HISTORICALREPORT.LASTUPDATEDDATETIME'), ExcelField: "SheetUpdatedDateTime"});
      ...
      returnList.push({ExcelColumn : this.softLabelsPipe.transform(this.translateService.instant('HISTORICALREPORT.ORIGINALESTIMATE'), this.softLabels), ExcelField: "SheetDeadLineDate"});
      returnList.push({ExcelColumn : this.translateService.instant('HISTORICALREPORT.LATESTDEVINPROGRESSDATE'), ExcelField: "SheetLatestDevInprogressDate"});
      returnList.push({ExcelColumn : this.translateService.instant('HISTORICALREPORT.LATESTDEVCOMPLETEDDATE'), ExcelField: "SheetLatestDevCompletedDate"});
      returnList.push({ExcelColumn : this.translateService.instant('HISTORICALREPORT.LATESTDEPLOYEDDATE'), ExcelField: "SheetDeployedDate"});
      returnList.push({ExcelColumn : this.translateService.instant('HISTORICALREPORT.LATESTQAAPPROVEDDATE'), ExcelField: "SheetQaApprovedDate"});
