...
export enum WorkspacesActionTypes {
    LoadWorkspacesListTriggered = "[Dashboard Module Workspace List Component] Initial Workspaces List  Triggered",
    LoadWorkspacesListCompleted = "[Dashboard Module Workspace List Component] Initial Workspaces List Completed",
    LoadUnHideWorkspacesListTriggered = "[Dashboard Module UnHide Workspace List Component] Initial UnHide Workspaces List  Triggered",
    LoadUnHideWorkspacesListCompleted = "[Dashboard Module UnHide Workspace List Component] Initial UnHide Workspaces List Completed",
    WorkspaceFailed = "[Dashboard Module Workspace List Component] Workspace List Load Failed",
    WorkspaceException = "[Dashboard Module Workspace List Component] Workspace List Exception Handled",
    LoadWorkspacesTriggered = "[Dashboard Module Workspace List Component] Initial Workspaces List Load Triggered",
    LoadWorkspacesCompleted = "[Dashboard Module Workspace List Component] Initial Workspaces List Load Completed",
    LoadHiddenWorkspacesListTriggered = "[Dashboard Module Hidden Workspace List Component] Initial Hidden Workspaces List  Triggered",
    LoadHiddenWorkspacesListCompleted = "[Dashboard Module Hidden Workspace List Component] Initial Hidden Workspaces List Completed",
    LoadWorkspaceByIdTriggered = "[Dashboard Module Workspace List Component] Initial Workspace By Id Load Triggered",
    LoadWorkspaceByIdCompleted = "[Dashboard Module Workspace List Component] Initial Workspace By Id Load Completed",
    LoadWorkspaceDeleteTriggered = "[Dashboard Module Workspace List Component] Initial Workspace Load Delete Triggered",
    LoadWorkspaceDeleteCompleted = "[Dashboard Module Workspace List Component] Initial Workspace Load Delete Completed",
    RefreshWorkspacesList = "[Dashboard Module Refresh List Component] Refresh Workspace List",
    LoadSnackbar = "[Dashboard Module Load snackbar Component] loads snackbar",
    WorkspaceEditCompletedWithInPlaceUpdate = "[Dashboard Module Workspace List Component] Initial Workspace Update Load Completed",
    RefreshHiddenWorkspacesList = "[Dashboard Module Refresh Hidden List Component] Refresh Hidden Workspace List",
    LoadWorkspacesCompletedIfNoId = "[Dashboard Module Workspace List Component] Initial Workspaces List Load Completed If No Id",
}
