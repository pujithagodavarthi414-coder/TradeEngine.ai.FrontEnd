...
export class TrackerScreenshotsComponent {
    ...
    getActTrackerUserActivityScreenshots() {
        ...
        this.dashboardService.getActTrackerUserActivityScreenshots(this.webAppUsageSearch).subscribe((responseData: any) => {
    ...
    getActTrackerUserActivityScreenshotsByWorkItemId() {
        ...
        this.dashboardService.getActTrackerUserActivityScreenshotsById(webAppUsageSearch).subscribe((responseData: any) => {
            if (responseData.success == true) {
                this.userActivityScreenshots = responseData.data;
                if (this.userActivityScreenshots.length == 0) {
                    this.noData = true;
    ...
    deleteScreenshots(formDirective: FormGroupDirective) {
        ...
        if (this.deleteForm.valid) {
            ...
            this.dashboardService.deleteMultipleScreenshots(deleteScreenshot).subscribe((responseData: any) => {
