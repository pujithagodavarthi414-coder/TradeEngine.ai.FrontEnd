...
export enum UserProfileActionTypes {
    GetUserProfileByIdTriggered = '[Dashboard Module User Profile Details Component] Get User Profile Details By Id Triggered',
    GetUserProfileByIdCompleted = '[Dashboard Module User Profile Details Component] Get User Profile Details By Id Completed',
    GetUserProfileByIdFailed = '[Dashboard Module User Profile Details Component] Get User Profile Details By Id Failed',
    CreateProfileImageTriggered = '[Dashboard Module User Profile Details Component] Create User Profile Details Triggered',
    CreateProfileImageCompleted = '[Dashboard Module User Profile Details Component] Create User Profile Details Completed',
    CreateProfileImageFailed = '[Dashboard Module User Profile Details Component] Create User Profile Details Failed',
    UpdateProfileImageById = '[Dashboard Module User Profile Details Component] Update User Profile Details By Id',
    UserIsViewingOthersProfile = '[Dashboard Module User Profile Details Component] User Is Viewing Others Profile',
    ExceptionHandled = '[Dashboard Module User Profile Details Component] Handle Exception',
}
