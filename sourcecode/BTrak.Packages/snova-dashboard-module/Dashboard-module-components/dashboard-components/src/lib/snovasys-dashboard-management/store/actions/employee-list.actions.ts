...
export enum EmployeeListActionTypes {
   LoadEmployeeListItemsTriggered = '[Dashboard Module Employee List Component] Initial Data Load Triggered',
   LoadEmployeeListItemsCompleted = '[Dashboard Module Employee List Component] Initial Data Load Completed',
   LoadEmployeeListItemsDetailsFailed = '[Dashboard Module Employee List Component] Initial Data Load Failed',
   CreateEmployeeListItemTriggered = '[Dashboard Module Employee List Component] Create Employee ListTriggered',
   CreateEmployeeListItemCompleted = '[Dashboard Module Employee List Component] Create Employee List Completed',
   CreateEmployeeListItemFailed = '[Dashboard Module Employee List Component] Create Employee List Failed',
   GetEmployeeListDetailsByIdTriggered = '[Dashboard Module Employee List Details Component] Get Employee List Details By Id Triggered',
   GetEmployeeListDetailsByIdCompleted = '[Dashboard Module Employee List Details Component] Get Employee List Details By Id Completed',
   GetEmployeeListDetailsByIdFailed = '[Dashboard Module Employee List Details Component] Get Employee List Details By Id Failed',
   UpdateEmployeeListDetailsById = '[Dashboard Module Employee List Details Component] Update Employee List Details By Id',
   RefreshEmployeeListDetailsList = '[Dashboard Module Employee List Details Component] Refresh Employee List Details List',
   ExceptionHandled = '[Dashboard Module Employee List Component] Handle Exception',
   LoadAllEmployeeDetailsListItemsTriggered = "[Dashboard Module Employee List Component] Initial All Employee Load Triggered",
   LoadAllEmployeeDetailsListItemsCompleted = "[Dashboard Module Employee List Component] Initial All Employee Load Completed"
}
