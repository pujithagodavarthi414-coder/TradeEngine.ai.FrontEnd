...
export class LeaveFrequencyEffects {
    ...
    loadLeaveTypesList$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(searchAction => {
            return this.dashboardService.getAllLeaveTypes(searchAction.leaveTypeSearchModel)
    ...
    upsertLeaveType$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(searchAction => {
            return this.dashboardService.upsertLeaveType(searchAction.leaveTypeInputModel)
