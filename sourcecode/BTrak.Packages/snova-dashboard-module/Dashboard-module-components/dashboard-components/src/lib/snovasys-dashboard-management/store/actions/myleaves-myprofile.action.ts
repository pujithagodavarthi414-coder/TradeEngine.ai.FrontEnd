...
export enum MyLeavesActionTypes {
    AddNewLeaveTriggered = '[Dashboard Module Leave Types Component] Upsert Leave Triggered',
    AddNewLeaveCompleted = '[Dashboard Module Leave Types Component] Upsert Leave Completed',
    AddNewLeaveFailed = '[Dashboard Module Leave Types Component] Upsert Leave Failed',
    LoadLeavesTriggered = '[Dashboard Module Leave Types Component] Leaves Initial Data Load Triggered',
    LoadLeavesCompleted = '[Dashboard Module Leave Types Component] Leaves Initial Data Load Completed',
    LoadLeavesFailed = '[Dashboard Module Leave Types Component] Leaves Initial Data Load Failed',
