...
export enum ChangePasswordActionTypes {
  ChangePasswordTriggered = "[Dashboard Module Change Password Component] Change Password Triggered",
  ChangePasswordCompleted = "[Dashboard Module Change Password Component] Change Password Completed",
  ChangePasswordFailed = "[Dashboard Module Change Password Component] Change Password Failed",
  ChangePasswordExceptionHandled = "[Dashboard Module Change Password Component] Exception Handled",
}
