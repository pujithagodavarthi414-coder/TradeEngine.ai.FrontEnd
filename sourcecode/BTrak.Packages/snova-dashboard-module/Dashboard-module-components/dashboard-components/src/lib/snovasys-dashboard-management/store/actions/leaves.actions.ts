...
export enum LeavesActionTypes {
    AddNewLeaveTriggered = '[Dashboard Module Leaves Component] Upsert Leave Triggered',
    AddNewLeaveCompleted = '[Dashboard Module Leaves Component] Upsert Leave Completed',
    AddNewLeaveFailed = '[Dashboard Module Leaves Component] Upsert Leave Failed',
    LoadLeavesTriggered = '[Dashboard Module Leaves Component] Leaves Initial Data Load Triggered',
    LoadLeavesCompleted = '[Dashboard Module Leaves Component] Leaves Initial Data Load Completed',
    LoadLeavesFailed = '[Dashboard Module Leaves Component] Leaves Initial Data Load Failed',
    ExceptionHandled = '[Dashboard Module Leaves Component] Handle Exception',
    LoadLeavesByIdTriggered = "[Dashboard Module Leaves Component] Load Leaves By Id Triggered",
    LoadLeavesByIdCompleted = "[Dashboard Module Leaves Component] Load Leaves By Id Completed",
    UpdateLeaveById = "[Dashboard Module Leaves Component] Update Leave By Id"
}
