...
import { PayrollmanagementRoutes} from 'module/module-components/src/lib/payroll-management.routing';
import { PayrollManagementModule } from 'module/module-components/src/lib/payroll-management.module';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot(PayrollmanagementRoutes, {
      useHash: false,
