...
export class SalaryWagesComponent {
    ...
    columnHeaders: any[] = [
        ...
        {title:'Actual employee salary',field:"actualEmployeeSalary"},
        {title:'Actual deduction',field:"actualDeduction"},
        {title:'Actual paid amount',field:"actualPaidAmount"},
    ...
    getSalaryWages(isExcel) {
        ...
        let salaryWagesModel = new SalaryWagesModel();
        salaryWagesModel.isActiveEmployeesOnly = this.isActiveEmployeesOnly;
        salaryWagesModel.entityId = this.selectedEntity;
        salaryWagesModel.userId = this.usersId;
        salaryWagesModel.date = this.fromDate ? this.fromDate.toString() + '-01' : null;
        salaryWagesModel.sortBy = this.sortBy;
        salaryWagesModel.sortDirectionAsc = this.sortDirection;
        salaryWagesModel.pageNumber = isExcel ? null : (this.state.skip / this.state.take) + 1;
        salaryWagesModel.pageSize = isExcel ? null : this.state.take;
        salaryWagesModel.searchText = this.searchText;
        this.payRollService.getRegisterOfWages(salaryWagesModel).subscribe((response: any) => {
