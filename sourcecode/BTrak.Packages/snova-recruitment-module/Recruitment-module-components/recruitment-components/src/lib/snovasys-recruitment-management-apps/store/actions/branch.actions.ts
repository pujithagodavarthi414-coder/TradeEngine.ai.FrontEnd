...
export enum BranchActionTypes {
    LoadBranchTriggered = '[Branch Component] Initial Data Load Triggered',
    LoadBranchCompleted = '[Branch  Component] Initial Data Load Completed',
    LoadBranchFailed = '[Branch  Component] Initial Data Load Failed',
    BranchExceptionHandled = '[Branch Component] HandleException',
}
