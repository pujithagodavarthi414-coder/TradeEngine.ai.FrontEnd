...
export enum UserActionTypes {
  LoadUsersTriggered = '[User Component] Initial Data Load Triggered',
  LoadUsersCompleted = '[User Component] Initial Data Load Completed',
  LoadUsersListTriggered = '[Users Component] Initial Data Users Triggered',
  LoadUsersListCompleted = '[Users Component] Initial Data  Users Completed',
  LoggedUserTriggered = '[Logged Component] Logged User Triggered',
  LoggedUserCompleted = '[Logged Component] Logged User Completed',
  LoadUsersCompletedFromCache = '[User Component] Initial Data Load Completed From Cache',
  CreateUsersTriggered = '[Create Component] Create User Triggered',
  CreateUsersCompleted = '[Create Component] Create User Completed',
  CreateUsersFailed = '[Create Component] Create Users Failed',
  GetUserByIdTriggered= '[Get Component] Get User By Id  Triggered',
  GetUserByIdCompleted= '[Get Component] Get User By Id  Completed',
  CreateUserCompletedWithInPlaceUpdate= '[User Component] Create User Completed WIth In Place Update',
  RefreshUsersList= '[Refresh Component] Refresh User List',
  ExceptionHandled = '[User Component] Exception Handled',
  RemoveUserFromList = '[User Component] Remove User From the list'
}
