...
export enum FileActionTypes {
    LoadFilesTriggered = '[SnovaAudisModule File Component] Initial Data Load Triggered',
    LoadFilesCompleted = '[SnovaAudisModule File Component] Initial Data Load Completed',
    LoadFilesFailed = '[SnovaAudisModule File Component] Initial Data Load Failed',
    CreateFileTriggered = '[SnovaAudisModule File Component] Create File Triggered',
    CreateFileCompleted = '[SnovaAudisModule File Component] Create File Completed',
    DeleteFileTriggered = '[SnovaAudisModule File Component] Delete File Triggered',
    DeleteFileCompleted = '[SnovaAudisModule File Component] Delete File Completed',
    CreateFileFailed = '[SnovaAudisModule File Component] Create File Failed',
    GetFileByIdTriggered = '[SnovaAudisModule File Component] Get File By Id Triggered',
    GetFileByIdCompleted = '[SnovaAudisModule File Component] Get File By Id Completed',
    UpdateFileById = '[SnovaAudisModule File Component] Update File By Id',
    RefreshFileList = '[SnovaAudisModule File Component] Refresh File List',
    RefreshMultipleFilesList = '[SnovaAudisModule File Component] Refresh Multiple Files List',
    FileDispatchActionStopped = '[SnovaAudisModule File Component] File Dispatch Action Stopped',
    ExceptionHandled = '[SnovaAudisModule File Component] Handle Exception',
}
...
export class ExceptionHandled implements Action {
    type = FileActionTypes.ExceptionHandled;
    searchFilesModel: SearchFileModel;
    filesList: FileInputModel[];
    upsertFileDetails: UpsertFileModel;
    upsertFileId: string[];
