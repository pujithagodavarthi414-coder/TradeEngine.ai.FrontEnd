...
export enum UserActionTypes {
  LoadUsersTriggered = "[SnovaAudisModule User Component] Initial Data Load Triggered",
  LoadUsersCompleted = "[SnovaAudisModule User Component] Initial Data Load Completed",
  LoadUsersListTriggered = "[SnovaAudisModule Users Component] Initial Data Users Triggered",
  LoadUsersListCompleted = "[SnovaAudisModule Users Component] Initial Data  Users Completed",
  LoggedUserTriggered = "[SnovaAudisModule Logged Component] Logged User Triggered",
  LoggedUserCompleted = "[SnovaAudisModule Logged Component] Logged User Completed",
  LoadUsersCompletedFromCache = "[SnovaAudisModule User Component] Initial Data Load Completed From Cache",
  CreateUsersTriggered = "[SnovaAudisModule Create Component] Create User Triggered",
  CreateUsersCompleted = "[SnovaAudisModule Create Component] Create User Completed",
  CreateUsersFailed = "[SnovaAudisModule Create Component] Create Users Failed",
  GetUserByIdTriggered= "[SnovaAudisModule Get Component] Get User By Id  Triggered",
  GetUserByIdCompleted= "[SnovaAudisModule Get Component] Get User By Id  Completed",
  CreateUserCompletedWithInPlaceUpdate= "[SnovaAudisModule User Component] Create User Completed WIth In Place Update",
  RefreshUsersList= "[SnovaAudisModule Refresh Component] Refresh User List",
  ExceptionHandled = "[SnovaAudisModule User Component] Exception Handled",
  RemoveUserFromList = "[SnovaAudisModule User Component] Remove User From the list"
}
