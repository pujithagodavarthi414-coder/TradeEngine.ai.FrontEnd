...
@Component({
    selector: "conduct-questions-subcategories",
    templateUrl: "./conduct-questions-subcategories.component.html",
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class ConductQuestionsSubcategoriesComponent {
    ...
    countQuestionsSelected(value, check) {
        ...
        let selectedQuestions = new ConductQuestionModel();
        selectedQuestions.auditCategoryId = this.categoriesData.auditCategoryId;
        selectedQuestions.questionsCount = this.noOfQuestionsSelected;
        this.categoryQuestionsCount.emit(selectedQuestions);
    }
