...
export enum FileUploadActionTypes {
  FileUploadActionTriggered = "[SnovaAuditsModule FileUpload Component] File Upload Action Triggered",
  FileUploadActionCompleted = "[SnovaAuditsModule FileUpload Component] File Upload Action Completed",
  FileUploadActionFailed = "[SnovaAuditsModule FileUpload Component] File Upload Action Failed",
  ExceptionHandled = "[SnovaAuditsModule FileUpload Component] File Upload Exception",
  GetReferenceIdOfFile = "[SnovaAuditsModule FileUpload Component] Get ReferenceId of File",
}
