...
export enum BoardTypesUiActionTypes {
  LoadBoardTypesUiTriggered = "[SnovaAudisModule BoardTypeUi Component] Initial Data Load Triggered",
  LoadBoardTypesUiCompleted = "[SnovaAudisModule BoardTypeUi Component] Initial Data Load Completed"
}
