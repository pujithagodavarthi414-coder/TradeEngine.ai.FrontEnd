...
export enum ProjectMembersActionTypes {
  LoadProjectMembersTriggered = "[SnovaAudisModule Project Member Component] Initial Data Load Triggered",
  LoadProjectMembersCompleted = "[SnovaAudisModule Project Member Component] Initial Data Load Completed",
  LoadProjectMembersFailed = "[SnovaAudisModule Project Member Component] Initial Data Load Failed",
  CreateProjectMembersTriggered = "[SnovaAudisModule Project Member Component] Create Project Member Triggered",
  CreateProjectMembersCompleted = "[SnovaAudisModule Project Member Component] Create Project Member Completed",
  CreateProjectMembersFailed = "[SnovaAudisModule Project Member Component] Create Project Member Failed",
  ExceptionHandled = "[SnovaAudisModule Project Member Component] Exception Handled",
  DeleteProjectMembersTriggered = "[SnovaAudisModule Project Member Component] Delete Project Member Triggered",
  DeleteProjectMembersCompleted = "[SnovaAudisModule Project Member Component] Delete Project Member Completed",
  DeleteProjectMembersFailed = "[SnovaAudisModule Project Member Component] Delete Project Member Failed",
  GetProjectMemberByIdTriggered = "[SnovaAudisModule Project Member Component] Get ProjectMember ById Triggered",
  GetProjectMemberByIdCompleted = "[SnovaAudisModule Project Member Component] Get ProjectMember ById Completed",
  GetProjectMemberByIdFailed = "[SnovaAudisModule Project Member Component] Get ProjectMember ById Failed",
  UpdateProjectMemberList = "[SnovaAudisModule Project Member Component] Update ProjectMember Component",
  RefreshProjectMembersList = "[SnovaAudisModule Project Member CComponent]Refresh ProjectMembers",
  GetNewProjectMembersList = "[SnovaAudisModule Project Member Component]Get Project Members List"
