...
@Component({
    selector: "conduct-select-question-view",
    templateUrl: "./conduct-select-question-view.component.html",
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class ConductSelectQuestionViewComponent {
    ...
    constructor(private store: Store<State>, private actionUpdates$: Actions, private cdRef: ChangeDetectorRef) {
        ...
        this.actionUpdates$.pipe(
            ...
            tap(() => {
                if (localStorage.getItem('selectedCategoryFilter') != null) {
                    ...
                    this.categoryName = categoryData.value;
        ...
        this.actionUpdates$.pipe(
            ...
            tap(() => {
                this.questionsForRuns$.subscribe(result => {
