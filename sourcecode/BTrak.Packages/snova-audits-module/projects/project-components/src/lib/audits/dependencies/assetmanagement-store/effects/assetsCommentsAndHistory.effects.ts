...
import { LoadAssetsCommentsAndHistoryItemsTriggered, AssetsCommentsAndHistoryActionTypes, ExceptionHandled, LoadAssetsCommentsAndHistoryItemsCompleted, LoadAssetsCommentsAndHistoryItemsFailed, AddAssetCommentTriggered, AddAssetCommentCompleted, AddAssetCommentFailed } from "../actions/assetsCommentsAndHistory.actions";
...
export class AssetsCommentsAndHistoryEffects {
  ...
  @Effect()
  exceptionHandledForAssetsCommentsAndHistory$: Observable<Action> = this.actions$.pipe(
    ofType<ExceptionHandled>(AssetsCommentsAndHistoryActionTypes.ExceptionHandled),
    switchMap((searchAction) => {
