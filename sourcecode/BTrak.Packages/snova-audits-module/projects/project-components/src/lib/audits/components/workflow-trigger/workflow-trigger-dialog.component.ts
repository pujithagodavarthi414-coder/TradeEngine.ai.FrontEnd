...
export class WorkFlowTriggerDialogComponent implements OnInit {
    ...
    constructor(private workFlowTriggerService: WorkFlowTriggerService, private genericFormService: WorkFlowTriggerService, private toastr: ToastrService, public dialogRef: MatDialogRef<WorkFlowTriggerDialogComponent>, @Inject(MAT_DIALOG_DATA) private data: any, public dialog: MatDialog, private cdRef: ChangeDetectorRef) {
    ...
    this.genericFormService.UploadFile(file).subscribe((responseData: any) => {
