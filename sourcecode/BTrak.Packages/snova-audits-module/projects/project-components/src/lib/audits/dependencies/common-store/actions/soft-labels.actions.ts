...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[SnovaAuditsModule softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[SnovaAuditsModule softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[SnovaAuditsModule softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[SnovaAuditsModule softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[SnovaAuditsModule softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[SnovaAuditsModule softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[SnovaAuditsModule softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[SnovaAuditsModule softLabel Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[SnovaAuditsModule softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[SnovaAuditsModule softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[SnovaAuditsModule softLabel Component] Update softLabel Field",
}
