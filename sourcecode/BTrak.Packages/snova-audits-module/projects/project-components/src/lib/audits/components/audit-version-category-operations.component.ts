...
@Component({
    selector: "audit-version-category-operations",
    templateUrl: "./audit-version-category-operations.component.html",
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class AuditVersionCategoryOperationsComponent extends AppFeatureBaseComponent implements OnInit {
