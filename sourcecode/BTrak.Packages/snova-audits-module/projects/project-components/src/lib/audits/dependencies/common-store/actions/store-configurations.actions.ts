...
export enum StoreConfigurationActionTypes {
    LoadStoreConfigurationsTriggered = '[SnovaAuditsModule Store Configuration Component] Initial Data Load Triggered',
    LoadStoreConfigurationsCompleted = '[SnovaAuditsModule Store Configuration Component] Initial Data Load Completed',
    LoadStoreConfigurationsFailed = '[SnovaAuditsModule Store Configuration Component] Initial Data Load Failed',
    ExceptionHandled = '[SnovaAuditsModule Store Configuration Component] Handle Exception',
}
