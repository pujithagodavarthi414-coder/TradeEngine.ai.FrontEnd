...
@Component({
    selector: "audit-questions-subcategories-shift-view",
    templateUrl: "./audit-questions-subcategories-shift-view.component.html",
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class AuditQuestionsSubCategoriesShiftViewComponent {
