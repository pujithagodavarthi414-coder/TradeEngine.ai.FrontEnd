...
> = createEntityAdapter<ProjectSearchResult>({
  ...
  sortComparer: (projectsSortAsc: ProjectSearchResult, projectsSortDesc: ProjectSearchResult) => projectsSortDesc.createdDateTime.toString().localeCompare(projectsSortAsc.createdDateTime.toString())
});
...
export function reducer(
  ...
  switch (action.type) {
    ...
    case ProjectActionTypes.ExceptionHandled:
      return {
        ...state,
        creatingProject: false,
        loadingProjects: false,
