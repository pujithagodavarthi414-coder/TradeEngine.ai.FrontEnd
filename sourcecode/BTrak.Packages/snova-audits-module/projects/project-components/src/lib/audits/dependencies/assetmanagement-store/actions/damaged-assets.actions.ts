...
export enum DamagedAssetsActionTypes {
    LoadRecentlyDamagedAssetsTriggered = '[Recently Damaged Assets Component] Initial Data Load Triggered',
    LoadRecentlyDamagedAssetsCompleted = '[Recently Damaged Assets Component] Initial Data Load Completed',
    LoadRecentlyDamagedAssetsFailed = '[Recently Damaged Assets Component] Initial Data Load Failed',
    ExceptionHandled = '[Recently Damaged Assets Component] HandleException',
}
...
export class ExceptionHandled implements Action {
    type = DamagedAssetsActionTypes.ExceptionHandled;
    damagedAssetsSearchResult: AssetInputModel;
    recentlyDamagedAssetsList: Assets[];
    validationMessages: any[];
