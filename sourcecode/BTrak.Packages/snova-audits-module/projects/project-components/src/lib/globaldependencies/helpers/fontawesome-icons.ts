...
import { faCalendarWeek, faChartArea, faChartPie, faFileContract, faFileUpload, faLockOpen, faStore, faTable, faTag, faTrashAlt, faFileSignature, faSortDown } from "@fortawesome/free-solid-svg-icons";
// tslint:disable-next-line: max-line-length
