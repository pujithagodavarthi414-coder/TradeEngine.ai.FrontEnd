...
export const initialState: State = {
  ...
  TimeSheetRestrictedData: null,
  isTimeSheetFetching: false
};
...
export function reducer(state: State = initialState, action: Action): State {
  switch (action.type) {
    ...
    case AuthenticationActionTypes.UserDetailsFetchedAfterLogin:
      return {
        ...state,
        userModel: (action as AuthenticationActions).userModel
      };
    ...
    case AuthenticationActionTypes.ExceptionHandled:
      ...
      case AuthenticationActionTypes.FetchTimeSheetButtonDetails:
        return { ...state, isTimeSheetFetching: true};
      case AuthenticationActionTypes.UserInitialDetailsFetchedCompleted:
        return { ...state, isTimeSheetFetching: false, TimeSheetRestrictedData: (action as UserInitialDetailsFetchedCompleted).userInitialData ? 
          JSON.parse((action as UserInitialDetailsFetchedCompleted).userInitialData) : null
        }
    default:
      return state;
  }
