import { Component, OnInit, ViewEncapsulation, NgModuleRef, NgModuleFactoryLoader, Inject, ViewContainerRef, Input, ComponentFactoryResolver, Compiler, ChangeDetectorRef } from '@angular/core';
...
@Component({
    selector: 'app-Productivity-area-View',
    templateUrl: `productivity-area-view.html`,
    encapsulation: ViewEncapsulation.None,
})

export class ProductivityAreaViewComponent extends CustomAppBaseComponent implements OnInit {

    componentInputs = {
        selectedApps: null,
        selectedWorkspaceId: null,
        dashboardName: null,
        defaultmonthfilter: null
    };
    ...
    set _dashboardName(data: string) {
        this.componentInputs.dashboardName = data;
    }
    ...
    constructor(
        ...
        super();
        this.componentInputs.defaultmonthfilter = true;
    }
    ...
    loadComponent() {
        ...
        var component = "filtered apps view"
        ...
        //         var componentDetails = allComponentsInModule.find(elementInArray =>
        //             elementInArray.name === "filtered apps view"
        //         );

        //         this.widgetGridComponent = this.ngModuleFactoryLoader.resolveComponentFactory(FilteredListviewComponent);
        //     });
    }
