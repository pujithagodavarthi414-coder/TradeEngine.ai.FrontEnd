...
export enum UserActionTypes {
  LoadUsersTriggered = "[Asset Apps User Component] Initial Data Load Triggered",
  LoadUsersCompleted = "[Asset Apps User Component] Initial Data Load Completed",
  LoadUsersListTriggered = "[Asset Apps Users Component] Initial Data Users Triggered",
  LoadUsersListCompleted = "[Asset Apps Users Component] Initial Data  Users Completed",
  LoggedUserTriggered = "[Asset Apps Logged Component] Logged User Triggered",
  LoggedUserCompleted = "[Asset Apps Logged Component] Logged User Completed",
  LoadUsersCompletedFromCache = "[Asset Apps User Component] Initial Data Load Completed From Cache",
  CreateUsersTriggered = "[Asset Apps Create Component] Create User Triggered",
  CreateUsersCompleted = "[Asset Apps Create Component] Create User Completed",
  CreateUsersFailed = "[Asset Apps Create Component] Create Users Failed",
  GetUserByIdTriggered = "[Asset Apps Get Component] Get User By Id  Triggered",
  GetUserByIdCompleted = "[Asset Apps Get Component] Get User By Id  Completed",
  CreateUserCompletedWithInPlaceUpdate = "[Asset Apps User Component] Create User Completed WIth In Place Update",
  RefreshUsersList = "[Asset Apps Refresh Component] Refresh User List",
  ExceptionHandled = "[Asset Apps User Component] Exception Handled",
  RemoveUserFromList = "[Asset Apps User Component] Remove User From the list"
}
