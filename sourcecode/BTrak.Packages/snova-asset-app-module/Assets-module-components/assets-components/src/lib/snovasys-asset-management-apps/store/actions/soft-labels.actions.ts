...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[Asset Apps softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[Asset Apps softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[Asset Apps softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[Asset Apps softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[Asset Apps softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[Asset Apps softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[Asset Apps softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[Asset Apps softLabel Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[Asset Apps softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[Asset Apps softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[Asset Apps softLabel Component] Update softLabel Field",
}
