...
export enum AssignedAssetsActionTypes {
    LoadRecentlyAssignedAssetsTriggered = '[Asset Apps Recently Assigned Assets Component] Initial Data Load Triggered',
    LoadRecentlyAssignedAssetsCompleted = '[Asset Apps Recently Assigned Assets Component] Initial Data Load Completed',
    LoadRecentlyAssignedAssetsFailed = '[Asset Apps Recently Assigned Assets Component] Initial Data Load Failed',
    AssignedAssetsExceptionHandled = '[Asset Apps Recently Assigned Assets Component] HandleException',
}
