...
export enum BranchActionTypes {
    LoadBranchTriggered = '[Asset Apps Branch Component] Initial Data Load Triggered',
    LoadBranchCompleted = '[Asset Apps Branch  Component] Initial Data Load Completed',
    LoadBranchFailed = '[Asset Apps Branch  Component] Initial Data Load Failed',
    BranchExceptionHandled = '[Asset Apps Branch Component] HandleException',
}
