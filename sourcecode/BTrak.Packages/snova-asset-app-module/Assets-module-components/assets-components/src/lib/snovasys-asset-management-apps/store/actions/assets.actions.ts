...
export enum AssetsActionTypes {
    LoadAssetsTriggered = '[Asset Apps Assets Component] Initial Data Load Triggered',
    LoadAssetsCompleted = '[Asset Apps Assets Component] Initial Data Load Completed',
    LoadAssetsFailed = '[Asset Apps Assets Component] Initial Data Load Failed',
    CreateAssetsTriggered = '[Asset Apps Assets Component] Create Asset Triggered',
    CreateAssetsCompleted = '[Asset Apps Assets Component] Create Asset Completed',
    CreateAssetsFailed = '[Asset Apps Assets Component] Create Asset Failed',
    GetAssetByIdTriggered = '[Asset Apps Assets Component] Get Asset By Id Triggered',
    GetAssetByIdCompleted = '[Asset Apps Assets Component] Get Asset By Id Completed',
    GetAssetByIdFailed = '[Asset Apps Assets Component] Get Asset By Id Failed',
    CreateAssetCompletedWithInPlaceUpdate = '[Asset Apps Asset Component] Create Asset Completed With InPlace Update',
    RefreshAssetsList = '[Asset Apps Asset Component] Refresh Assets List',
    RemoveAssetsFromTheList = '[Asset Apps Asset Component] Asset To Be Removed',
    GetSelectedAssetTriggered = '[Asset Apps Asset Component] Get Selected Asset Triggered',
    GetSelectedAssetCompleted = '[Asset Apps Asset Component] Get Selected Asset Completed',
    AssetsTotalCountTriggered = '[Asset Apps Asset Component] Assets Total Count Triggered',
    AssetsTotalCountCompleted = '[Asset Apps Asset Component] Assets Total Count Completed',
    GetAssetsByIdsTriggered = '[Asset Apps] Assets Load By Ids Triggered',
    GetAssetsByIdsCompleted = '[Asset Apps] Assets Load By Ids Completed',
    GetAssetsByIdsFailed = '[Asset Apps] Assets Load By Ids Failed',
    AssetsExceptionHandled = '[Asset Apps Assets Component] HandleException',
    RemoveMultipleAssetsIdsCompleted = "[Asset Apps Assets Component] Remove Multiple Assets Ids Completed",
    LoadAssetsCommentsAndHistory = "[Asset Apps Assets Component] Load Assets Comments and history",
}
