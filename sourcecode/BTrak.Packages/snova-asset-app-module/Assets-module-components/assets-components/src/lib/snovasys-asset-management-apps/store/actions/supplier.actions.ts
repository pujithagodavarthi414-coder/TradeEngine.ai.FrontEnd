...
export enum SupplierActionTypes {
    LoadSuppliersTriggered = '[Asset Apps Supplier Component] Initial Data Load Triggered',
    LoadSuppliersCompleted = '[Asset Apps Supplier Component] Initial Data Load Completed',
    LoadSuppliersFailed = '[Asset Apps Supplier Component] Initial Data Load Failed',
    CreateSupplierTriggered = '[Asset Apps Supplier Component] Create Supplier Triggered',
    CreateSupplierCompleted = '[Asset Apps Supplier Component] Create Supplier Completed',
    CreateSupplierFailed = '[Asset Apps Supplier Component] Create Supplier Failed',
    SupplierExceptionHandled = '[Asset Apps Supplier Component] HandleException',
}
