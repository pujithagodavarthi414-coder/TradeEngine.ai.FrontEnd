...
export enum EmployeeListActionTypes {
    LoadEmployeeListItemsTriggered = '[Asset Apps Employee List Component] Initial Data Load Triggered',
    LoadEmployeeListItemsCompleted = '[Asset Apps Employee List Component] Initial Data Load Completed',
    LoadEmployeeListItemsDetailsFailed = '[Asset Apps Employee List Component] Initial Data Load Failed',
    CreateEmployeeListItemTriggered = '[Asset Apps Employee List Component] Create Employee ListTriggered',
    CreateEmployeeListItemCompleted = '[Asset Apps Employee List Component] Create Employee List Completed',
    CreateEmployeeListItemFailed = '[Asset Apps Employee List Component] Create Employee List Failed',
    GetEmployeeListDetailsByIdTriggered = '[Asset Apps Employee List Details Component] Get Employee List Details By Id Triggered',
    GetEmployeeListDetailsByIdCompleted = '[Asset Apps Employee List Details Component] Get Employee List Details By Id Completed',
    GetEmployeeListDetailsByIdFailed = '[Asset Apps Employee List Details Component] Get Employee List Details By Id Failed',
    UpdateEmployeeListDetailsById = '[Asset Apps Employee List Details Component] Update Employee List Details By Id',
    RefreshEmployeeListDetailsList = '[Asset Apps Employee List Details Component] Refresh Employee List Details List',
    EmployeeListExceptionHandled = '[Asset Apps Employee List Component] Handle Exception',
    LoadAllEmployeeDetailsListItemsTriggered = "[Asset Apps Employee List Component] Initial All Employee Load Triggered",
    LoadAllEmployeeDetailsListItemsCompleted = "[Asset Apps Employee List Component] Initial All Employee Load Completed"
}
