...
export enum ProductDetailsActionTypes {
    LoadProductDetailsTriggered = '[Asset Apps Product Details Component] Initial Data Load Triggered',
    LoadProductDetailsCompleted = '[Asset Apps Product Details Component] Initial Data Load Completed',
    LoadProductDetailsFailed = '[Asset Apps Product Details Component] Initial Data Load Failed',
    CreateProductDetailsTriggered = '[Asset Apps Product Details Component] Create Product Details Triggered',
    CreateProductDetailsCompleted = '[Asset Apps Product Details Component] Create Product Details Completed',
    CreateProductDetailsFailed = '[Asset Apps Product Details Component] Create Product Details Failed',
    GetProductDetailsByIdTriggered = '[Asset Apps Product Details Component] Get Product Details By Id Triggered',
    GetProductDetailsByIdCompleted = '[Asset Apps Product Details Component] Get Product Details By Id Completed',
    GetProductDetailsByIdFailed = '[Asset Apps Product Details Component] Get Product Details By Id Failed',
    DeleteProductDetailsCompleted = '[Asset Apps Product Details Component] Delete Product Details Completed',
    UpdateProductDetailsById = '[Asset Apps Product Details Component] Update Product Details By Id',
    RefreshProductDetailsList = '[Asset Apps Product Details Component] Refresh Product Details List',
    ProductDetailsExceptionHandled = '[Asset Apps Product Details Component] HandleException',
}
