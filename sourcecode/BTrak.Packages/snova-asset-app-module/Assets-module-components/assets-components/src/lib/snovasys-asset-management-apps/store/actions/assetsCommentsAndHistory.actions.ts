...
export enum AssetsCommentsAndHistoryActionTypes {
    LoadAssetsCommentsAndHistoryItemsTriggered = "[Asset Apps AssetsCommentsAndHistory List Component] Initial Data Load Triggered",
    LoadAssetsCommentsAndHistoryItemsCompleted = "[Asset Apps AssetsCommentsAndHistory List Component] Initial Data Load Completed",
    LoadAssetsCommentsAndHistoryItemsFailed = "[Asset Apps AssetsCommentsAndHistory List Component] Initial Data Load Failed",
    AddAssetCommentTriggered= "[Asset Apps AssetsCommentsAndHistory List Component] Create Asset Comments Triggered",
    AddAssetCommentCompleted= "[Asset Apps AssetsCommentsAndHistory List Component] Create Asset Comments Completed",
    AddAssetCommentFailed= "[Asset Apps AssetsCommentsAndHistory List Component] Create Asset Comments Failed",
    AssetCommentsAndHistoryExceptionHandled = "[Asset Apps AssetsCommentsAndHistory List Component] Handle Exception"
}
