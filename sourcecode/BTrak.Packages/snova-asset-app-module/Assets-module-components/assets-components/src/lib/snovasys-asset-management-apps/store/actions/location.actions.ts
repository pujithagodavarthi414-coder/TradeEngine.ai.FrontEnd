...
export enum LocationActionTypes {
    LoadLocationsTriggered = '[Asset Apps Location Component] Initial Data Load Triggered',
    LoadLocationsCompleted = '[Asset Apps Location Component] Initial Data Load Completed',
    LoadLocationsFailed = '[Asset Apps Location Component] Initial Data Load Failed',
    CreateLocationTriggered = '[Asset Apps Location Component] Create Location Triggered',
    CreateLocationCompleted = '[Asset Apps Location Component] Create Location Completed',
    CreateLocationFailed = '[Asset Apps Location Component] Create Location Failed',
    GetLocationsByIdTriggered = '[Asset Apps location Component] Get location By Id Triggered',
    GetLocationsByIdCompleted = '[Asset Apps location Component] Get location By Id Completed',
    GetLocationsByIdFailed = '[Asset Apps location Component] Get location By Id Failed',
    DeleteLocationsCompleted = '[Asset Apps location Component] Delete location Completed',
    UpdateLocationsById = '[Asset Apps location Component] Update location By Id',
    RefreshLocations = '[Asset Apps location Component] Refresh location List',
    LocationExceptionHandled = '[Asset Apps Location Component] HandleException',
}
