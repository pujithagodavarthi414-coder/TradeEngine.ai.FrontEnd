...
import { faAddressCard, faCalendar, faCalendarAlt, faCalendarDay, faCaretDown, faCaretRight, faCaretSquareRight, faClipboard, faClone, faCoffee, faCompress, faEllipsisH, faEllipsisV, faEnvelope, faEnvelopeOpenText, faEnvelopeSquare, faEyeSlash, faFileCsv, faFileExcel, faFileExport, faFileImport, faFileInvoice, faFilePdf, faHistory, faParking, faPhoneAlt, faPlusSquare, faQuestionCircle, faShareSquare, faSort, faUserTimes, faPhone, faUniversity, faRupeeSign, faMicrophone, faMicrophoneSlash, faVideo, faVideoSlash } from "@fortawesome/free-solid-svg-icons";
...
import { faCircleNotch, faDesktop, faRedoAlt, faSmile, faTasks,faSyncAlt } from "@fortawesome/free-solid-svg-icons";
...
const shareButtonsIcons = [
    ...
    faUndo, faCreditCard, faMoneyBillAlt, faUtensils, faPlay,
    faExclamationTriangle, faBookmark, faCogs, faAngleDoubleLeft,
    faChevronLeft, faAngleDoubleRight, faChevronRight, faFolder,
    ...
    faFacebookF, faDesktop, faRedoAlt, faParking, faTasks, faCircleNotch,faSyncAlt,
    faFrown, faComment, faPhone, faUniversity, faRupeeSign, faCreditCard
