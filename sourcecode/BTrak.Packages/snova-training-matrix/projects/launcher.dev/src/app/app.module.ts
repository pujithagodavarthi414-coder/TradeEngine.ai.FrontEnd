...
import { TrainingRoutes } from 'projects/project-components/src/lib/training-matrix/training-matrix.routes';
...
@NgModule({
  ...
  imports: [
    RouterModule.forRoot(TrainingRoutes, { relativeLinkResolution: 'legacy' }),
    BrowserModule,
