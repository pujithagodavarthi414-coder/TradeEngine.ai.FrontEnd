...
@Component({
  selector: 'app-progress-kp1',
  templateUrl: './progress-kp1.component.html'
})

export class ProgressKPI1Component extends AppBaseComponent implements OnInit {
  ...
  openProgressDialog() {
    ...
    const dialogRef = this.dialog.open(this.progressDetailDialog, {
        ...
        data: {
            ...
            dataSourceId: '44D9BA24-F183-499F-81CC-8DCE38479549',
