...
@Component({
  selector: 'app-ffb-productivity-riau',
  templateUrl: './ffb-productivity-riau.component.html'
})

export class FFBProductivityRiauComponent extends AppBaseComponent implements OnInit {
    xAxisCategories: any[];
    categorySeries: any = [];
