...
import { faCalendarWeek, faChartArea, faChartPie, faFileContract, faFileUpload, faLockOpen, faStore, faTable, faTag, faTrashAlt, faFileSignature, faSortDown, faFileImage, faBolt, faFire, faSnowflake, faTint, faCloud, faRecycle, faCertificate, faStar, faIndustry, faObjectGroup, faToggleOff, faToggleOn, faTrashRestore } from "@fortawesome/free-solid-svg-icons";
// tslint:disable-next-line: max-line-length
...
import { faBinoculars, faCircleNotch, faDesktop, faRedoAlt, faSmile, faSyncAlt, faTasks,faShareAlt } from "@fortawesome/free-solid-svg-icons";

const shareButtonsIcons = [
    faBox, faMapMarker, faKey, faGraduationCap, faBriefcase,faShareAlt,
    ...
    faFrown, faChartPie, faTable, faChartArea, faStore, faHouseDamage, faCloudUploadAlt,faFileContract,
    faBinoculars, faCog, faPaperclip, faCalendarWeek, faTrashAlt, faFileUpload, faPlusCircle,faSortDown,
    faFileImage,faBolt,faFire,faSnowflake,faTint,faCloud,faRecycle,faTrash,faCertificate,faStar,faIndustry
    ,faObjectGroup, faShareSquare,faToggleOff,faToggleOn,faTrashRestore];
