...
import { CustomAppBaseComponent } from 'app-builder-module-components/app-builder-components/src/lib/globaldependencies/components/componentbase';
import * as _ from 'underscore';
import { WidgetList } from 'app-builder-module-components/app-builder-components/src/lib/builder/models/widget-list.model';
import { WidgetService } from 'app-builder-module-components/app-builder-components/src/lib/builder/services/widget.service';
import { DragedWidget } from './app.module/models/dragedWidget';
