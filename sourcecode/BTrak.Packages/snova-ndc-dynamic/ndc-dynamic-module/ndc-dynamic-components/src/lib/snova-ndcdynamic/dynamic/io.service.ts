...
export class IoService implements OnDestroy {
  ...
  update(
    ...
    this.checkInit();
    this.updateIO(inputs, outputs, dynamicFactory);
  ...
  private updateIO(inputs: InputsType, outputs: OutputsType, dynamicFactory: any) {
    this._inputs = inputs;
    this._outputs = outputs;
    this._dynamicFactory = dynamicFactory;
  }
