...
export enum WorkspacesActionTypes {
    ...
    LoadChildWorkspacesTriggered = "[Workspace List Component] Initial Child Workspaces List Load Triggered",
    LoadChildWorkspacesCompleted = "[Workspace List Component] Initial Child Workspaces List Load Completed",
...
export class LoadChildWorkspacesTriggered implements Action {
    type = WorkspacesActionTypes.LoadChildWorkspacesTriggered;
    workspaceId: string;
    Workspaces: WorkspaceList;
    searchWorkspacesSuccess: WorkspaceList[];
    searchWorkspace: WorkspaceList;
...
export class LoadChildWorkspacesCompleted implements Action {
    type = WorkspacesActionTypes.LoadChildWorkspacesCompleted;
    workspace: WorkspaceList;
    Workspaces: WorkspaceList;
    searchWorkspacesSuccess: WorkspaceList[];
    searchWorkspace: WorkspaceList;
