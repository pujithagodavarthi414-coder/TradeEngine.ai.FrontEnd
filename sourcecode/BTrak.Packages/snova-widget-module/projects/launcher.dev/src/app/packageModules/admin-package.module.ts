...
export class AdminComponentSupplierService {
  ...
  static components =  [
    ...
    // {
    //     name: "Reference type",
    //     componentTypeObject: ReferenceTypeComponent
    // },
    {
        name: "Region",
    ...
    // {
    //     name: "Soft label",
    //     componentTypeObject: SoftLabelComponent
    // },            
    {
        name: "State",
    ...
    // {
    //     name: "Crud operation",
    //     componentTypeObject: PermissionsComponent
    // },
    {
    ...
    // {
    //     name: "Manage transition deadline",
    //     componentTypeObject: TransitionDeadlinesComponent         
    // },
    {
