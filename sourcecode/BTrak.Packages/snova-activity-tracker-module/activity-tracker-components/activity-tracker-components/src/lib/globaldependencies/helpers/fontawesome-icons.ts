...
import { faCalendarWeek, faChartArea, faChartPie, faFileContract, faFileUpload, faLockOpen, faStore, faTable, faTag, faTrashAlt, faFileSignature, faSortDown, faClipboardList, faHandPointRight } from "@fortawesome/free-solid-svg-icons";
// tslint:disable-next-line: max-line-length
...
const shareButtonsIcons = [
    ...
    faAngleLeft, faAngleRight, faSignal, faBug, faGripLinesVertical, faHandPointRight,
    faThumbsDown, faWindowClose, faTimesCircle, faCircle, faFastBackward,
    faCaretSquareDown, faEnvelopeOpenText, faEnvelope, faFastForward, faClipboardList,
    ...
    faBinoculars, faCog, faPaperclip, faCalendarWeek, faTrashAlt, faFileUpload, faPlusCircle,faSortDown,faVideo];
