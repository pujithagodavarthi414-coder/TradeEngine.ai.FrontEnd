...
@Component({
    selector: "app-fm-component-screenshots",
...
export class ScreenshotsComponent extends CustomAppBaseComponent implements OnInit {
    ...
    constructor(private datePipe: DatePipe,
        private timeUsageService: TimeUsageService, private translateService: TranslateService, private cookieService: CookieService) {
        super();
    }
