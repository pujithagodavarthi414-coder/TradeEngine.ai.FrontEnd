...
export enum EmployeeRosterActionTypes {
    CreateEmployeeRosterSolutionTriggered = '[Employee Roster Component] Create Employee Roster Solution Triggered',
    CreateEmployeeRosterSolutionCompleted = '[Employee Roster Component] Create Employee Roster Solution Completed',
    CreateEmployeeRosterSolutionFailed = '[Employee Roster Component] Create Employee Roster Solution Failed',
    CreateEmployeeRosterPlanTriggered = '[Employee Roster Component] Create Employee Roster Plan Triggered',
    CreateEmployeeRosterPlanCompleted = '[Employee Roster Component] Create Employee Roster Plan Completed',
    CreateEmployeeRosterPlanFailed = '[Employee Roster Component] Create Employee Roster Plan Failed',
    UpdateEmployeeRosterTriggered = '[Employee Roster Component] Update Employee Roster Triggered',
    UpdateEmployeeRosterCompleted = '[Employee Roster Component] Update Employee Roster Completed',
    UpdateEmployeeRosterFailed = '[Employee Roster Component] Update Employee Roster Failed',
    DeleteEmployeeRosterCompleted = '[Employee Roster Component] Delete Employee Roster Completed',
    LoadEmployeeRosterPlansTriggered = '[Employee Roster Component] Load Employee Roster Plans Triggered',
    LoadEmployeeRosterPlansCompleted = '[Employee Roster Component] Load Employee Roster Plans Completed',
    LoadEmployeeRosterPlansFailed = '[Employee Roster Component] Load Employee Roster Plans Failed',
    ApproveEmployeeRosterTriggered = '[Employee Roster Component] Approve Employee Roster Plans Triggered',
    ApproveEmployeeRosterCompleted = '[Employee Roster Component] Approve Employee Roster Plans Completed',
    ApproveEmployeeRosterFailed = '[Employee Roster Component] Approve Employee Roster Plans Failed',
    GetEmployeeRosterByIdTriggered = '[Employee Roster Component] Get Employee Roster By Id Triggered',
    GetEmployeeRosterByIdCompleted = '[Employee Roster Component] Get Employee Roster By Id Completed',
    GetEmployeeRosterByIdFailed = '[Employee Roster Component] Get Employee Roster By Id Failed',
    GetRosterSolutionsByIdTriggered = '[Employee Roster Component] Get Roster Solutions By Id Triggered',
    GetRosterSolutionsByIdCompleted = '[Employee Roster Component] Get Roster Solutions By Id Completed',
    GetRosterSolutionsByIdFailed = '[Employee Roster Component] Get Roster Solutions By Id Failed',
    GetEmployeeRosterPlanRequestByIdTriggered = '[Employee Roster Component] Get Employee Roster Plan By Request Id Triggered',
    GetEmployeeRosterPlanRequestByIdCompleted = '[Employee Roster Component] Get Employee Roster Plan By Request Id Completed',
    GetEmployeeRosterPlanRequestByIdFailed = '[Employee Roster Component] Get Employee Roster Plan By Request Id Failed',
    UpdateEmployeeRosterById = '[Employee Roster Component] Update Employee Roster By Id',
    UpdateEmployeeRosterPlanByRequestId = '[Employee Roster Component] Update Employee Roster Plan By Request Id',
    RefreshEmployeeRosterList = '[Employee Roster Component] Refresh Employee Roster List',
    LoadEmployeeRosterTemplatePlansTriggered = '[Employee Roster Component] Load Employee Roster Template Plan Triggered',
    LoadEmployeeRosterTemplatePlansCompleted = '[Employee Roster Component] Load Employee Roster Template Plan Completed',
    LoadEmployeeRosterTemplatePlansFailed = '[Employee Roster Component] Load Employee Roster Template Plan Failed',
    ExceptionHandled = '[Employee Roster Component] Handle Exception',
    LoadEmployeeRateSheetDetailsTriggered = '[Employee Rate Sheet Details Component] Initial Data Load Triggered',
    LoadEmployeeRateSheetDetailsCompleted = '[Employee Rate Sheet Details Component] Initial Data Load Completed',
    LoadEmployeeRateSheetDetailsFailed = '[Employee Rate Sheet Details Component] Initial Data Load Failed',
