...
import { EmployeeTimeSheetDialogComponent } from '../rostering/components/employee-timesheet-dialog.component';
import { ApproverTimeSheetDialogComponent } from "../rostering/components/approver-timesheet-dialogue.component";
import { EmployeeTimeSheetSubmissionComponent } from "../rostering/components/employee-timesheets-submission.component";
import { ApproverTimeSheetSubmissionComponent } from "../rostering/components/approver-timesheet-submission.component";
...
@NgModule({
  ...
  declarations: [
    EmployeeTimeSheetDialogComponent, ApproverTimeSheetDialogComponent, EmployeeTimeSheetSubmissionComponent,
    ApproverTimeSheetSubmissionComponent, ConvertUtcToLocalTimePipe, FetchSizedAndCachedImagePipe,CustomAppBaseComponent,
    RemoveSpecialCharactersPipe],

  exports: [EmployeeTimeSheetDialogComponent, ApproverTimeSheetDialogComponent, EmployeeTimeSheetSubmissionComponent,
    ApproverTimeSheetSubmissionComponent],

  // entryComponents: [EmployeeTimeSheetDialogComponent, ApproverTimeSheetDialogComponent, EmployeeTimeSheetSubmissionComponent,
  //   ApproverTimeSheetSubmissionComponent],
...
export class RosterWidgetModule {
