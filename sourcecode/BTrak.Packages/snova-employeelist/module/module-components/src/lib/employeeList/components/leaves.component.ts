...
import { LeavesListComponent } from "@snovasys/snova-leave-management";
...
export class leavesComponent extends CustomAppBaseComponent  implements OnInit {

    private ngModuleRef: NgModuleRef<any>;
    injector: any;
    inputs: any;
    outputs: any;
    leaveMangementComponent: any;
    ...
    loadComponent() {
        ...
        var module = _.find(modules, function(module){ return module.modulePackageName == 'LeavesManagementPackageModule' });
        ...
        (path() as Promise<NgModuleFactory<any> | Type<any>>)
            ...
            var componentDetails = allComponentsInModule.find(elementInArray =>
              elementInArray.name === "Leaves list"
            );
            
            this.leaveMangementComponent = this.ngModuleRef.componentFactoryResolver.resolveComponentFactory(componentDetails.componentTypeObject);
          });
      }
}
