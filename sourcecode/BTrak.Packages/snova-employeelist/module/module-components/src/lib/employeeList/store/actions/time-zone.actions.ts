...
export enum TimeZoneListActionTypes {
    LoadTimeZoneListItemsTriggered = '[Employee List TimeZone List Component] Initial Data Load Triggered',
    LoadTimeZoneListItemsCompleted = '[Employee List TimeZone List Component] Initial Data Load Completed',
    LoadTimeZoneListItemsFailed = '[Employee List List Component] Initial Data Load Failed',
    ExceptionHandled = '[Employee List TimeZone List Component] Handle Exception',
}
