...
export enum DepartmentListActionTypes {
    LoadDepartmentListItemsTriggered = '[Employee List Department List Component] Initial Data Load Triggered',
    LoadDepartmentListItemsCompleted = '[Employee List Department List Component] Initial Data Load Completed',
    LoadDepartmentListItemsFailed = '[Employee List Department List Component] Initial Data Load Failed',
    ExceptionHandled = '[Employee List Department List Component] Handle Exception',
}
