...
export class HrAreaSettingsComponent extends CustomAppBaseComponent  implements OnInit {
    ...
    constructor(
        private vcr: ViewContainerRef,private projectModulesService: EmployeeModulesService, private compiler: Compiler) {
        super();
    }
