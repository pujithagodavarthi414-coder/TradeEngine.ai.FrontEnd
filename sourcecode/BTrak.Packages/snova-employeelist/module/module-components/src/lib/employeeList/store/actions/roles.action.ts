...
export enum RolesListActionTypes {
    LoadRolesTriggered = '[Employee List Roles Component] Initial Data Load Triggered',
    LoadRolesCompleted = '[Employee List Roles Component] Initial Data Load Completed',
    LoadRolesFailed= '[Employee List Roles Component] Initial Data Load Failed',
    RolesExceptionHandled = '[Employee List Roles Component] Handle Exception',
}
