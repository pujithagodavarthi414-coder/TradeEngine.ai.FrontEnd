...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[Employee List softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[Employee List softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[Employee List softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[Employee List softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[Employee List  Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[Employee List softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[Employee List softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[Employee List  Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[Employee List softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[Employee List softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[Employee List softLabel Component] Update softLabel Field",
}
