...
import { UpsertsoftLabelTriggered, softLabelsActionTypes, UpsertsoftLabelCompleted, UpsertsoftLabelFailed, ExceptionDetailsHandled, GetsoftLabelsTriggered, GetsoftLabelsCompleted, GetsoftLabelsFailed, GetsoftLabelByIdTriggered, GetsoftLabelByIdCompleted, GetsoftLabelByIdFailed, UpdatesoftLabelField } from "../actions/soft-labels.actions";
import { SoftLabelConfigurationModel } from '../../models/softlabels-model';
import { ShowValidationMessages, ShowExceptionMessages } from '../actions/notification-validator.action';
import { SoftLabelConfigurationService } from '../../servicces/softlabels.service';
...
export class SoftLabelConfigurationEffects {
        ...
        switchMap(action => {
            return this.softLabelService
                ...
                .pipe(map((response: any) => {
                    ...
                    catchError(error => {
                        return of(new ExceptionDetailsHandled(error));
                    })
                );
        })
    );
    ...
    exceptionHandled$: Observable<Action> = this.actions$.pipe(
        ofType<ExceptionDetailsHandled>(softLabelsActionTypes.ExceptionDetailsHandled),
        switchMap(searchAction => {
    ...
    constructor(
        ...
        private softLabelService: SoftLabelConfigurationService
    ) { }
}