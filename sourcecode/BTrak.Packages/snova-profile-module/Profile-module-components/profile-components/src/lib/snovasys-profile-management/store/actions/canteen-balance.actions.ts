...
export enum CanteenBalanceActionTypes {
    LoadCanteenBalanceTriggered = '[Profile Module Canteen Balance Component] Initial Data Load Triggered',
    LoadCanteenBalanceCompleted = '[Profile Module Canteen Balance Component] Initial Data Load Completed',
    LoadCanteenBalanceDetailsFailed = '[Profile Module Canteen Balance Component] Load Canteen Balance Details Failed',
    ExceptionHandled = '[Profile Module Canteen Balance Component] Handle Exception',
}
