...
export enum EmployeeListActionTypes {
   LoadEmployeeListItemsTriggered = '[Profile Module Employee List Component] Initial Data Load Triggered',
   LoadEmployeeListItemsCompleted = '[Profile Module Employee List Component] Initial Data Load Completed',
   LoadEmployeeListItemsDetailsFailed = '[Profile Module Employee List Component] Initial Data Load Failed',
   CreateEmployeeListItemTriggered = '[Profile Module Employee List Component] Create Employee ListTriggered',
   CreateEmployeeListItemCompleted = '[Profile Module Employee List Component] Create Employee List Completed',
   CreateEmployeeListItemFailed = '[Profile Module Employee List Component] Create Employee List Failed',
   GetEmployeeListDetailsByIdTriggered = '[Profile Module Employee List Details Component] Get Employee List Details By Id Triggered',
   GetEmployeeListDetailsByIdCompleted = '[Profile Module Employee List Details Component] Get Employee List Details By Id Completed',
   GetEmployeeListDetailsByIdFailed = '[Profile Module Employee List Details Component] Get Employee List Details By Id Failed',
   UpdateEmployeeListDetailsById = '[Profile Module Employee List Details Component] Update Employee List Details By Id',
   RefreshEmployeeListDetailsList = '[Profile Module Employee List Details Component] Refresh Employee List Details List',
   ExceptionHandled = '[Profile Module Employee List Component] Handle Exception',
   LoadAllEmployeeDetailsListItemsTriggered = "[Profile Module Employee List Component] Initial All Employee Load Triggered",
   LoadAllEmployeeDetailsListItemsCompleted = "[Profile Module Employee List Component] Initial All Employee Load Completed"
}
