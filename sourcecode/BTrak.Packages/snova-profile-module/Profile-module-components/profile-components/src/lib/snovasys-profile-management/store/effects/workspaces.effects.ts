...
export class WorkspaceEffects {
    ...
    constructor(
        private actions$: Actions, private translateService: TranslateService, 
    ...
    loadWorkspacesList$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(getAction => {
            return this.dashboardService.GetWorkspaceList(getAction.WorkspacesList).pipe(
                map((Workspaces: any) => {
    ...
    loadWorkspaces$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(getAction => {
            return this.dashboardService.UpsertWorkspace(getAction.workspace).pipe(
                map((workspaces: any) => {
                    if (workspaces.success == true) {
    ...
    loadWorkspaceById$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(getAction => {
            return this.dashboardService.GetWorkspaceList(getAction.searchWorkspace).pipe(
    ...
    workspaceDelete$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(getAction => {
            return this.dashboardService.DeleteWorkspace(getAction.deleteWorkspace).pipe(
                map((workspaces: any) => {
                    if (workspaces.success == true) {
                        this.newWorkspace = false;
                        this.hideWorkspace = false;
    ...
    workspaceUnHide$: Observable<Action> = this.actions$.pipe(
        ...
        switchMap(getAction => {
            return this.dashboardService.UpsertWorkspace(getAction.unHideWorkspace).pipe(
                map((workspaces: any) => {
                    if (workspaces.success == true) {
                        this.workspaceId = workspaces.data;
