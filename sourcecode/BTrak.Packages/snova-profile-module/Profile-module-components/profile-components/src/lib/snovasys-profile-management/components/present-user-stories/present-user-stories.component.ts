...
@Component({
  selector: 'app-present-user-stories',
  templateUrl: './present-user-stories.component.html'
})

export class PresentUserStoriesComponent extends CustomAppBaseComponent implements OnInit {
  softLabels$: Observable<SoftLabelConfigurationModel[]>;
  softLabels: SoftLabelConfigurationModel[];
  presentDeadLineDataDetails: ImminentDeadLineData[];
  ...
  getAllUserStories() {
    ...
    this.presentDeadLineDataDetails = [];
    ...
    imminentDeadLineData.DependencyText = 'CurrentUserStories';
    ...
    this.myProfileService.getAllUserStories(imminentDeadLineData).subscribe((responseData: any) => {
      ...
      this.presentDeadLineDataDetails = responseData.data;
      if (responseData.data.length != 0)
        this.totalCount = this.presentDeadLineDataDetails[0].totalCount;
      else {
        this.totalCount = 0;
      }
    });
