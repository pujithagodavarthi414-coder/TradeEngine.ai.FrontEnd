...
export enum AuthenticationActionTypes {
  UserDetailsFetching = "[Profile Module Authentication] Fetching User Details",
  UserDetailsFetched = "[Profile Module Authentication] Fetched User Details",
  RoleDetailsFetchOnReload = "[Profile Module Authentication] Role Details Fetched On Reload",
  RoleDetailsFetched = "[Profile Module Authentication] Role Details Fetched",
  RolesFetchTriggered = "[Profile Module Authentication] Fetching Roles Triggered",
  RolesFetchFailed = '[Profile Module Authentication] Fetching Roles Failed',
  AuthenticationExceptionHandled = '[Profile Module Authentication] Exception Handling',
  GetCompanySettingsTriggered = "[Profile Module Authentication] Get Company Settings Triggered",
  GetCompanySettingsCompleted = "[Profile Module Authentication] Get Company Settings Completed",
  GetCompanySettingsFailed = "[Profile Module Authentication] Get Company Settings Failed",
}
