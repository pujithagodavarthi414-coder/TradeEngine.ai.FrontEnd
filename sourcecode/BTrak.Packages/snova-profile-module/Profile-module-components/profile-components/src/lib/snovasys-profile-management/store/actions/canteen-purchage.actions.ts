...
export enum CanteenPurchaseItemActionTypes {
    LoadCanteenPurchaseItemsTriggered = '[Profile Module Canteen Purchase Item Component] Initial Data Load Triggered',
    LoadCanteenPurchaseItemsCompleted = '[Profile Module Canteen Purchase Item Component] Initial Data Load Completed',
    LoadCanteenPurchaseItemsFailed = '[Profile Module Canteen Purchase Item Component] Initial Data Load Failed',
    LoadMyCanteenPurchasesTriggered = '[Profile Module My Canteen Purchases Component] Initial Data Load Triggered',
    LoadMyCanteenPurchasesCompleted = '[Profile Module My Canteen Purchases Component] Initial Data Load Completed',
    LoadMyCanteenPurchasesFailed = '[Profile Module My Canteen Purchases Component] Initial Data Load Failed',
    CreateCanteenPurchaseItemTriggered = '[Profile Module Canteen Purchase Item Component] Create Canteen Purchase Item Triggered',
    CreateCanteenPurchaseItemCompleted = '[Profile Module Canteen Purchase Item Component] Create Canteen Purchase Item Completed',
    CreateCanteenPurchaseItemFailed = '[Profile Module Canteen Purchase Item Component] Create Canteen Purchase Item Failed',
    CanteenExceptionHandled = '[Profile Module Canteen Purchase Item Component] Handle Exception',
}
