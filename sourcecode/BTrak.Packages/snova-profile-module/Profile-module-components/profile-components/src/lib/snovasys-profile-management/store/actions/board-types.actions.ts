...
export enum BoardTypesActionTypes {
  LoadBoardTypesTriggered = "[Profile Module BoardTypes Component] Initial Data Load Triggered",
  LoadBoardTypesCompleted = "[Profile Module BoardTypes Component] Initial Data Load Completed",
  ExceptionHandled = "[Profile Module BoardTypes Component]Exception Handled"
}
