...
export enum ChangePasswordActionTypes {
  ChangePasswordTriggered = "[Profile Module Change Password Component] Change Password Triggered",
  ChangePasswordCompleted = "[Profile Module Change Password Component] Change Password Completed",
  ChangePasswordFailed = "[Profile Module Change Password Component] Change Password Failed",
  ChangePasswordExceptionHandled = "[Profile Module Change Password Component] Exception Handled",
}
