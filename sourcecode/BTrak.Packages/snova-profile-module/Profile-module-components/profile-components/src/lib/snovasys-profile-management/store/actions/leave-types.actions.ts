...
export enum LeaveTypeActionTypes {
    LoadLeaveTypesTriggered = '[Profile Module Leave Types Component] Initial Data Load Triggered',
    LoadLeaveTypesCompleted = '[Profile Module Leave Types Component] Initial Data Load Completed',
    LoadLeaveTypesFailed = '[Profile Module Leave Types Component] Initial Data Load Failed',
    LoadLeaveTypeByIdTriggered = '[Profile Module Leave Types Component] Leave Type By Id Triggered',
    LoadLeaveTypeByIdCompleted = '[Profile Module Leave Types Component] Leave Type By Id Completed',
    LoadLeaveTypeByIdFailed = '[Profile Module Leave Types Component] Leave Type By Id Failed',
    AddNewLeaveTypeTriggered = '[Profile Module Leave Types Component] New Leave Type Triggered',
    AddNewLeaveTypeCompleted = '[Profile Module Leave Types Component] New Leave Type Completed',
    AddNewLeaveTypeFailed = '[Profile Module Leave Types Component] New Leave Type Failed',
    UpdateLeaveTypeTriggered = '[Profile Module Leave Types Component] Update Type Triggered',
    UpdateLeaveTypeCompleted = '[Profile Module Leave Types Component] Update Type Completed',
    UpdateLeaveTypeFailed = '[Profile Module Leave Types Component] Update Type Failed',
