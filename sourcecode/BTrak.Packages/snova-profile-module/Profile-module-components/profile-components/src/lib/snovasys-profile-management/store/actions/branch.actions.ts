...
export enum BranchActionTypes {
    LoadBranchTriggered = '[Profile Module Branch Component] Initial Data Load Triggered',
    LoadBranchCompleted = '[Profile Module Branch  Component] Initial Data Load Completed',
    LoadBranchFailed = '[Profile Module Branch  Component] Initial Data Load Failed',
    BranchExceptionHandled = '[Profile Module Branch Component] HandleException',
}
