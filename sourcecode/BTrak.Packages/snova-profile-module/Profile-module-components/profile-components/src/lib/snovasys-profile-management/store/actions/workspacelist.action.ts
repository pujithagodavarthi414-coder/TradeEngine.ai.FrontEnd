...
export enum WorkspacesActionTypes {
    LoadWorkspacesListTriggered = "[Profile Module Workspace List Component] Initial Workspaces List  Triggered",
    LoadWorkspacesListCompleted = "[Profile Module Workspace List Component] Initial Workspaces List Completed",
    LoadUnHideWorkspacesListTriggered = "[Profile Module UnHide Workspace List Component] Initial UnHide Workspaces List  Triggered",
    LoadUnHideWorkspacesListCompleted = "[Profile Module UnHide Workspace List Component] Initial UnHide Workspaces List Completed",
    WorkspaceFailed = "[Profile Module Workspace List Component] Workspace List Load Failed",
    WorkspaceException = "[Profile Module Workspace List Component] Workspace List Exception Handled",
    LoadWorkspacesTriggered = "[Profile Module Workspace List Component] Initial Workspaces List Load Triggered",
    LoadWorkspacesCompleted = "[Profile Module Workspace List Component] Initial Workspaces List Load Completed",
    LoadHiddenWorkspacesListTriggered = "[Profile Module Hidden Workspace List Component] Initial Hidden Workspaces List  Triggered",
    LoadHiddenWorkspacesListCompleted = "[Profile Module Hidden Workspace List Component] Initial Hidden Workspaces List Completed",
    LoadWorkspaceByIdTriggered = "[Profile Module Workspace List Component] Initial Workspace By Id Load Triggered",
    LoadWorkspaceByIdCompleted = "[Profile Module Workspace List Component] Initial Workspace By Id Load Completed",
    LoadWorkspaceDeleteTriggered = "[Profile Module Workspace List Component] Initial Workspace Load Delete Triggered",
    LoadWorkspaceDeleteCompleted = "[Profile Module Workspace List Component] Initial Workspace Load Delete Completed",
    RefreshWorkspacesList = "[Profile Module Refresh List Component] Refresh Workspace List",
    LoadSnackbar = "[Profile Module Load snackbar Component] loads snackbar",
    WorkspaceEditCompletedWithInPlaceUpdate = "[Profile Module Workspace List Component] Initial Workspace Update Load Completed",
    RefreshHiddenWorkspacesList = "[Profile Module Refresh Hidden List Component] Refresh Hidden Workspace List",
    LoadWorkspacesCompletedIfNoId = "[Profile Module Workspace List Component] Initial Workspaces List Load Completed If No Id",
}
