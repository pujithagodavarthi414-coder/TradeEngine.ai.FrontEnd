...
export class DashboardService {
   ...
   //exit
	...
	SetAsDefaultDashboardPersistance(workspaceId: string) {
		...
		return this.http.post(APIEndpoint + ApiUrls.SetAsDefaultDashboardPersistance, body, httpOptions);
	}
	...
	ResetToDefaultDashboardPersistance(workspaceId: string) {
		...
		return this.http.post(APIEndpoint + ApiUrls.ResetToDefaultDashboard, body, httpOptions);
	}
