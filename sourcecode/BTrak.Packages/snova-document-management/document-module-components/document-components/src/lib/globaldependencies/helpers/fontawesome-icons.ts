...
const shareButtonsIcons = [
    ...
    faUserFriends, faPuzzlePiece, faCodeBranch, faThList, faFileAlt, faChartLine,faCompressAlt,
    faHistory, faClone, faEllipsisV, faTwitter, faInstagram, faLinkedin, faYoutube,faExpandAlt,
    faFacebookF, faDesktop, faRedoAlt, faParking, faTag, faTasks, faCircleNotch, faSyncAlt,faFolderPlus,
