...
import { StoreActionTypes, LoadStoreTriggered, LoadStoreCompleted, LoadStoreFailed, CreateStoreTriggered, CreateStoreCompleted, DeleteStoreCompleted, CreateStoreFailed, GetStoreByIdTriggered, GetStoreByIdCompleted, UpdateStoreById, RefreshStoreList, StoreExceptionHandled } from "../actions/store.actions";
...
export class StoreEffects {
        ...
        switchMap(searchAction => {
            return this.masterDataManagementService
                ...
                .pipe(map((StoreList: any) => {
                    ...
                    catchError(error => {
                        return of(new StoreExceptionHandled(error));
                    })
                );
        })
    );
    ...
    exceptionHandled$: Observable<Action> = this.actions$.pipe(
        ofType<StoreExceptionHandled>(StoreActionTypes.StoreExceptionHandled),
        switchMap(searchAction => {
    ...
    constructor(
        ...
        private masterDataManagementService: StoreManagementService,
