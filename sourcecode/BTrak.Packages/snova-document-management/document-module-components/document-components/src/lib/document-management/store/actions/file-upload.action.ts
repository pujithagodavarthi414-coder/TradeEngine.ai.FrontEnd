...
export enum FileUploadActionTypes {
  FileUploadActionTriggered = "[Documents FileUpload Component] File Upload Action Triggered",
  FileUploadActionCompleted = "[Documents FileUpload Component] File Upload Action Completed",
  FileUploadActionFailed = "[Documents FileUpload Component] File Upload Action Failed",
  ExceptionHandled = "[Documents FileUpload Component] File Upload Exception",
  GetReferenceIdOfFile = "[Documents FileUpload Component] Get ReferenceId of File",
}
