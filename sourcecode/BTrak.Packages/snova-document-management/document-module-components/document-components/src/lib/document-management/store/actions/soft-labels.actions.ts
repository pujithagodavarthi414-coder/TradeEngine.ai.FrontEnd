...
export enum softLabelsActionTypes {
    UpsertsoftLabelTriggered = "[Documents softLabel Component] Upsert softLabel Triggered",
    UpsertsoftLabelCompleted = "[Documents softLabel Component] Upsert softLabel Completed",
    UpsertsoftLabelFailed = "[Documents softLabel Component] Upsert softLabel Failed",
    ExceptionHandled = "[Documents softLabel Component] ExceptionHandled",
    GetsoftLabelsTriggered = "[Documents softLabel Component] Get softLabel Triggered",
    GetsoftLabelsCompleted = "[Documents softLabel Component] Get softLabel Completed",
    GetsoftLabelsFailed = "[Documents softLabel Component] Get softLabel Failed",
    GetsoftLabelByIdTriggered = "[Documents softLabel Component]Get softLabel By Id Triggered",
    GetsoftLabelByIdCompleted = "[Documents softLabel Component]Get softLabel By Id Completed",
    GetsoftLabelByIdFailed = "[Documents softLabel Component]Get softLabel By Id Failed",
    UpdatesoftLabelField = "[Documents softLabel Component] Update softLabel Field",
}
