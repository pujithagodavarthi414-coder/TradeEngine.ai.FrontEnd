...
import { BillingModule,BillingRoutes } from '@thetradeengineorg1/snova-module-tabs-module';
...
@NgModule({
    imports: [
      BillingModule.forChild(moduleLoader),
    ...
    providers:[
        ...
        {provide: 'TradingModuleLoader', useValue: moduleLoader as any },
