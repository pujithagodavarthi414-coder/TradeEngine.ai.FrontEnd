...
export enum AuthenticationActionTypes {
  AuthenticateUser = "[Authentication] Authenticate User",
  Authenticated = "[Authentication] Authenticated",
  CompanyWorkItemStartFunctionalityRequired = "[Authentication] CompanyWorkItemStartFunctionalityRequired",
  CompanyWorkItemStartFunctionalityRequiredFailed = "[Authentication] CompanyWorkItemStartFunctionalityRequired Failed",
  CompanyWorkItemStartFunctionalityRequiredSuccess = "[Authentication] CompanyWorkItemStartFunctionalityRequired Success",
  SignedOff = "[Authentication] Signed Off",
  ...
  InitializeAfterLoginData = "[Authentication] Initialize after login data",
  RolesFetchTriggered = "[Authentication] Fetching Roles Triggered",
  RolesFetchFailed = '[Authentication] Fetching Roles Failed',
  EntityRolesFetchTriggered = "[Authentication] Fetching Entity Roles Triggered",
  EntityRoleDetailsFetched = "[Authentication] Entity Role Details Fetched",
  EntityRolesByUserIdFetchTriggered = "[Authentication] Fetching Entity Roles By UserId Triggered",
  EntityReolesByUserIdFetchCompleted = "[Authentication] Fetching EntityRoles By UserId Completed",
  EntityRolesByUserIdFetchFailed = "[Authentication] Fetching EntityRoles By UserId Failed",
  GetCompanyThemeTriggered = "[Authentication] GEt Company Theme Triggered",
  GetCompanyThemeCompleted = "[Authentication] GEt Company Theme Completed",
  GetCompanyThemeFailed = "[Authentication] GEt Company Theme Failed",
  ClearDemoDataTriggred = "[Authentication] Clear Demo Data Triggred",
  ClearDemoDataCompleted = "[Authentication] Clear Demo Data Completed",
  ClearDemoDataFailed = "[Authentication] Clear Demo Data Failed",
  GetUserStoreIdTriggered = '[Authentication] Get User Store Id Triggered',
  GetUserStoreIdCompleted = '[Authentication] Get User Store Id Completed',
  GetUserStoreIdFailed = '[Authentication] Get User Store Id Failed',
  ExceptionHandled = '[Authentication] Exception Handling',
  AuthenticateNewUser = "[Authentication] Authenticate New User",
