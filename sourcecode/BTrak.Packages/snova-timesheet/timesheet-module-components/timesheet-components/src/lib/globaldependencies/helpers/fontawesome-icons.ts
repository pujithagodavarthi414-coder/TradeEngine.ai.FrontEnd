...
import { faCalendarWeek, faChartArea, faChartPie, faFileContract, faFileUpload, faLockOpen, faStore, faTable, faTag, faTrashAlt, faFileSignature, faSortDown, faClipboardList } from "@fortawesome/free-solid-svg-icons";
// tslint:disable-next-line: max-line-length
...
const shareButtonsIcons = [
    ...
    faFastBackward, faFastForward, faUsers, faPrint, faDownload, faClipboard, faClipboardList,
