...
export enum StoreConfigurationActionTypes {
    LoadStoreConfigurationsTriggered = '[DropZone Store Configuration Component] Initial Data Load Triggered',
    LoadStoreConfigurationsCompleted = '[DropZone Store Configuration Component] Initial Data Load Completed',
    LoadStoreConfigurationsFailed = '[DropZone Store Configuration Component] Initial Data Load Failed',
    ExceptionHandled = '[DropZone Store Configuration Component] Handle Exception',
}
