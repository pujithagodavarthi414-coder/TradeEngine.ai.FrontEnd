...
export enum StoreActionTypes {
    LoadStoreTriggered = '[DropZone Store Component] Initial Data Load Triggered',
    LoadStoreCompleted = '[DropZone Store Component] Initial Data Load Completed',
    LoadStoreFailed = '[DropZone Store Component] Initial Data Load Failed',
    CreateStoreTriggered = '[DropZone Store Component] Create Store Triggered',
    CreateStoreCompleted = '[DropZone Store Component] Create Store Completed',
    DeleteStoreCompleted = '[DropZone Store Component] Delete Store Completed',
    CreateStoreFailed = '[DropZone Store Component] Create Store Failed',
    GetStoreByIdTriggered = '[DropZone Store Component] Get Store By Id Triggered',
    GetStoreByIdCompleted = '[DropZone Store Component] Get Store By Id Completed',
    UpdateStoreById = '[DropZone Store Component] Update Store By Id',
    RefreshStoreList = '[DropZone Store Component] Refresh Store List',
    ExceptionHandled = '[DropZone Store Component] Handle Exception',
}
...
export class ExceptionHandled implements Action {
    type = StoreActionTypes.ExceptionHandled;
    storeSearchModel: StoreSearchModel;
    storesList: StoreModel[];
    upsertStoreModel: StoreModel;
    upsertedStoreId: string;
