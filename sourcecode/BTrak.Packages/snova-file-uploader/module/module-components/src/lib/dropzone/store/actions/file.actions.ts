...
export enum FileActionTypes {
    LoadFilesTriggered = '[DropZone File Component] Initial Data Load Triggered',
    LoadFilesCompleted = '[DropZone File Component] Initial Data Load Completed',
    LoadFilesFailed = '[DropZone File Component] Initial Data Load Failed',
    CreateFileTriggered = '[DropZone File Component] Create File Triggered',
    CreateFileCompleted = '[DropZone File Component] Create File Completed',
    DeleteFileTriggered = '[DropZone File Component] Delete File Triggered',
    DeleteFileCompleted = '[DropZone File Component] Delete File Completed',
    CreateFileFailed = '[DropZone File Component] Create File Failed',
    GetFileByIdTriggered = '[DropZone File Component] Get File By Id Triggered',
    GetFileByIdCompleted = '[DropZone File Component] Get File By Id Completed',
    UpdateFileById = '[DropZone File Component] Update File By Id',
    RefreshFileList = '[DropZone File Component] Refresh File List',
    RefreshMultipleFilesList = '[DropZone File Component] Refresh Multiple Files List',
    FileDispatchActionStopped = '[DropZone File Component] File Dispatch Action Stopped',
    ExceptionHandled = '[DropZone File Component] Handle Exception',
}
