...
import { FileActionTypes, LoadFilesTriggered, LoadFilesCompleted, LoadFilesFailed, CreateFileTriggered, CreateFileCompleted, CreateFileFailed, DeleteFileCompleted, GetFileByIdTriggered, GetFileByIdCompleted, RefreshFileList, UpdateFileById, ExceptionHandled, RefreshMultipleFilesList, DeleteFileTriggered, FileDispatchActionStopped } from "../actions/file.actions";
...
export class FileEffects {
    ...
    exceptionHandled$: Observable<Action> = this.actions$.pipe(
        ofType<ExceptionHandled>(FileActionTypes.ExceptionHandled),
        switchMap(searchAction => {
