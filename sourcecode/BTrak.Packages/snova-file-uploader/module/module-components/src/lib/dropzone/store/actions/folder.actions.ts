...
export enum FolderActionTypes {
    LoadFoldersAndFilesTriggered = '[DropZone Folder Component] Initial Data Folders and Files Load Triggered',
    LoadFoldersAndFilesCompleted = '[DropZone Folder Component] Initial Data Folders and Files Load Completed',
    LoadFoldersAndFilesFailed = '[DropZone Folder Component] Initial Data Folders and Files Load Failed',
    // LoadFoldersTriggered = '[DropZone Folder Component] Initial Data Load Triggered',
    LoadFoldersCompleted = '[DropZone Folder Component] Initial Data Load Completed',
    LoadBreadcrumbCompleted = '[DropZone Folder Component] Initial Breadcrumb Data Load Completed',
    LoadStoreDataCompleted = '[DropZone Folder Component] Initial Store Data Load Completed',
    LoadFolderDescriptionCompleted = '[DropZone Folder Component] Initial Load Folder Description Completed',
    LoadFoldersFailed = '[DropZone Folder Component] Initial Data Load Failed',
    CreateFolderTriggered = '[DropZone Folder Component] Create Folder Triggered',
    CreateFolderCompleted = '[DropZone Folder Component] Create Folder Completed',
    DeleteFolderCompleted = '[DropZone Folder Component] Delete Folder Completed',
    CreateFolderFailed = '[DropZone Folder Component] Create Folder Failed',
    GetFolderByIdTriggered = '[DropZone Folder Component] Get Folder By Id Triggered',
    GetFolderByIdCompleted = '[DropZone Folder Component] Get Folder By Id Completed',
    UpdateFolderById = '[DropZone Folder Component] Update Folder By Id',
    RefreshFolderList = '[DropZone Folder Component] Refresh Folder List',
    ExceptionHandled = '[DropZone Folder Component] Handle Exception',
}
