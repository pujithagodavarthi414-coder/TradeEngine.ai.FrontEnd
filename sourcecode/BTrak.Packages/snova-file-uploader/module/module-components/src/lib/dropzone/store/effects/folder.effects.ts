...
import { FolderActionTypes, LoadFoldersCompleted, LoadFoldersFailed, CreateFolderTriggered, ExceptionHandled, DeleteFolderCompleted, CreateFolderCompleted, CreateFolderFailed, GetFolderByIdTriggered, GetFolderByIdCompleted, UpdateFolderById, RefreshFolderList, LoadFoldersAndFilesTriggered, LoadFoldersAndFilesCompleted, LoadBreadcrumbCompleted, LoadStoreDataCompleted, LoadFoldersAndFilesFailed, LoadFolderDescriptionCompleted } from "../actions/folder.actions";
...
export class FolderEffects {
    ...
    exceptionHandled$: Observable<Action> = this.actions$.pipe(
        ofType<ExceptionHandled>(FolderActionTypes.ExceptionHandled),
        switchMap(searchAction => {
