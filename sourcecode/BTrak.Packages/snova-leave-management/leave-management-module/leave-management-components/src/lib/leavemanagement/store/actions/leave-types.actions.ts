...
export enum LeaveTypeActionTypes {
    LoadLeaveTypesTriggered = '[Leave management Leave Types Component] Initial Data Load Triggered',
    LoadLeaveTypesCompleted = '[Leave management Leave Types Component] Initial Data Load Completed',
    LoadLeaveTypesFailed = '[Leave management Leave Types Component] Initial Data Load Failed',
    LoadLeaveTypeByIdTriggered = '[Leave management Leave Types Component] Leave Type By Id Triggered',
    LoadLeaveTypeByIdCompleted = '[Leave management Leave Types Component] Leave Type By Id Completed',
    LoadLeaveTypeByIdFailed = '[Leave management Leave Types Component] Leave Type By Id Failed',
    AddNewLeaveTypeTriggered = '[Leave management Leave Types Component] New Leave Type Triggered',
    AddNewLeaveTypeCompleted = '[Leave management Leave Types Component] New Leave Type Completed',
    AddNewLeaveTypeFailed = '[Leave management Leave Types Component] New Leave Type Failed',
    UpdateLeaveTypeTriggered = '[Leave management Leave Types Component] Update Type Triggered',
    UpdateLeaveTypeCompleted = '[Leave management Leave Types Component] Update Type Completed',
    UpdateLeaveTypeFailed = '[Leave management Leave Types Component] Update Type Failed',
