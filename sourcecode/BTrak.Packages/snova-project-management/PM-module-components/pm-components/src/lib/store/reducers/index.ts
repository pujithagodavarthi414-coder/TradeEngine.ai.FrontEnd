...
import { AuthenticationActionTypes } from '../../snovasys-projects/store/actions/authentication.actions';
 ...
 */
export const metaReducers: MetaReducer<State>[] = !environent.production
