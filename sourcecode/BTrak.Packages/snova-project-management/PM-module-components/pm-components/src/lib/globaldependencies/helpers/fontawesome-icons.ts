...
import { faCalendarWeek, faChartArea, faChartPie, faFileContract, faFileUpload, faLockOpen, faStore, faTable, faTag, faTrashAlt, faFileSignature, faSortDown, faUnlink, faListAlt, faShare, faForward } from "@fortawesome/free-solid-svg-icons";
// tslint:disable-next-line: max-line-length
...
const shareButtonsIcons = [
    ...
    faBinoculars, faCog, faPaperclip, faCalendarWeek, faTrashAlt, faFileUpload, faPlusCircle,faSortDown, faUnlink,faListAlt,faShare,faForward,faArrowDown];
