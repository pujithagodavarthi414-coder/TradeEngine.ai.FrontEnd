...
export class AppFeatureBaseComponent implements OnInit {
  canAccess_entityType_feature_ArchiveAction: Boolean;
  ...
  canAccess_entityType_feature_ViewAuditProjectMembers : Boolean;
  canAccess_entityType_feature_AddOrUpdateAuditProjectMember : Boolean;
  canAccess_entityType_feature_ArchiveAuditProjectMember : Boolean;
  ...
  ngOnInit() {
    ...
    this.canAccess_entityType_feature_ViewAuditProjectMembers = _.find(roles, function (role: any) { return role.entityFeatureId.toLowerCase() == EntityTypeFeatureIds.EntityTypeFeature_ViewAuditProjectMembers.toString().toLowerCase(); }) != null;
    this.canAccess_entityType_feature_AddOrUpdateAuditProjectMember = _.find(roles, function (role: any) { return role.entityFeatureId.toLowerCase() == EntityTypeFeatureIds.EntityTypeFeature_AddOrUpdateAuditProjectMember.toString().toLowerCase(); }) != null;
    this.canAccess_entityType_feature_ArchiveAuditProjectMember = _.find(roles, function (role: any) { return role.entityFeatureId.toLowerCase() == EntityTypeFeatureIds.EntityTypeFeature_ArchiveAuditProjectMember.toString().toLowerCase(); }) != null;
    ...
    this.canAccess_entityType_feature_ArchiveAction = _.find(roles, function (role: any) { return role.entityFeatureId.toLowerCase() == EntityTypeFeatureIds.EntityTypeFeature_ArchiveAction.toString().toLowerCase(); }) != null;
  }
}
