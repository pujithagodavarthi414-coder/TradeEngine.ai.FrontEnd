...
export enum ProjectFeaturesActionTypes {
  LoadProjectFeaturesTriggered = "[Snovasys-PM][Project Feature Component] Initial Data Load Triggered",
  LoadProjectFeaturesCompleted = "[Snovasys-PM][Project Feature Component] Initial Data Load Completed",
  CreateProjectFeaturesTriggered = "[Snovasys-PM][Project Feature Component] Create Project Feature Triggered",
  CreateProjectFeaturesCompleted = "[Snovasys-PM][Project Feature Component] Create Project Feature Completed",
  CreateProjectFeaturesFailed = "[Snovasys-PM][Project Feature Component] Create Project Feature Failed",
  GetProjectFeatureByIdTriggered = "[Snovasys-PM][Project Feature Component] Get Project feature By Id Triggered",
  GetProjectFeatureByIdCompleted = "[Snovasys-PM][Project Feature Component] Get Project feature By Id Completed",
  GetProjectFeatureByIdFailed = "[Snovasys-PM][Project Feature Component] Get Project feature By Id Failed",
  RefreshProjectFeaturesList = "[Snovasys-PM][Project Feature Component] Refresh Project Features list",
  UpdateProjectFeature = "[Snovasys-PM][Project Feature Component] Update Project feature",
  ArchiveProjectFeatureTriggered = "[Snovasys-PM][Project Feature Component] Archive Project feature Triggered",
  ArchiveProjectFeatureCompleted = "[Snovasys-PM][Project Feature Component] Archive Project feature Completed",
  ArchiveProjectFeatureFailed = "[Snovasys-PM][Project Feature Component] Archive Project feature Failed",
  ProjectFeaturesExceptionHandled = "[Snovasys-PM][ProjectFeaturesExceptionHandled]Project FeaturesExceptionHandled"
}
...
// tslint:disable-next-line: max-classes-per-file
export class ProjectFeaturesExceptionHandled implements Action {
  type = ProjectFeaturesActionTypes.CreateProjectFeaturesFailed;
  projectFeatures: ProjectFeature[];
  projectFeature: ProjectFeature;
  projectId: string;
