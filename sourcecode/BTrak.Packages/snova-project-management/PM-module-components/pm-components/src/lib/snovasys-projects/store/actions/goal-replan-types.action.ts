...
export enum GoalReplanActionsActionTypes {
  LoadGoalReplanActionsTriggered = "[Snovasys-PM][GoalReplanActions Component] Initial Data Load Triggered",
  LoadGoalReplanActionsCompleted = "[Snovasys-PM][GoalReplanActions Component] Initial Data Load Completed",
  LoadGoalReplanActionsCompletedFromCache = "[Snovasys-PM][GoalReplanActions Component] Initial Data Load Completed From Cache",
  InsertGoalReplanTriggered = "[Snovasys-PM][GoalReplanActions Component] Insert Goal Replan Triggered",
  InsertGoalReplanCompleted = "[Snovasys-PM][GoalReplanActions Component] Insert Goal Replan Completed",
  InsertGoalReplanFailed = "[Snovasys-PM][GoalReplanActions Component] Insert Goal Replan Failed"
}
