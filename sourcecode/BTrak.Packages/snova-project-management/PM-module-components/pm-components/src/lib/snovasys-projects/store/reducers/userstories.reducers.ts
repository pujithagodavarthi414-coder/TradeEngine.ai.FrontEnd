...
export function reducer(
  ...
  switch (action.type) {
    case UserStoryActionTypes.SearchUserStories:
      return { ...initialState, loadingUserStories: true };

    case UserStoryActionTypes.SearchUserStoriesComplete:
      return adapter.addAll(action.userStoryList, {
        ...state,
        loadingUserStories: false
      });

    case UserStoryActionTypes.SearchUserStoriesFailed:
      return { ...state, loadingUserStories: false };

    case UserStoryActionTypes.SearchAllUserStories:
    ...
    case UserStoryActionTypes.UpdateUniqueUserStories:
      return adapter.updateMany(action.userStoryUpdatesMultiple.userStoryUpdateMultiple, {
        ...state,
        loadingUserStories: false,
        reOrderUserStoriesLoading: false
    ...
    case UserStoryActionTypes.GetUserStoryByIdTriggered:
      return { ...state, getUserStoryById: true, creatingMultipleUserStories: false };
    ...
    case UserStoryActionTypes.GetUniqueUserStoryByUniqueIdTriggered:
      return { ...state, getUniqueUserStoryById: true };
    ...
    case UserStoryActionTypes.UserStoryExceptionHandled:
    ...
    case UserStoryActionTypes.RemoveUniquePageUserStories:
      state = adapter.removeMany(action.userStories, state);
      return { ...state, archiveUserStoriesLoading: false };
    case UserStoryActionTypes.ArchivekanbanGoalsFailed:
      return { ...state, archiveUserStoriesLoading: false };

    case UserStoryActionTypes.SearchUserStoriesError:
