...
export function reducer(
    ...
    switch (action.type) {
      case GoalFiltersActionTypes.GetGoalFiltersTriggered:
        return { ...initialState, loadingGoalFilters: true };
        case GoalFiltersActionTypes.GetGoalFiltersCompleted:
            return goalFiltersAdapter.addMany(action.goalFiltersList, {
              ...state,
              loadingGoalFilters: false
            });
      ...
      case GoalFiltersActionTypes.UpsertGoalFiltersFailed:
        ...
        case GoalFiltersActionTypes.ArchiveGoalFiltersFailed:
          return { ...state, archiveGoalFilters: false };
          case GoalFiltersActionTypes.GoalFiltersExceptionHandled:
            return { ...state, archiveGoalFilters: false, loadingGoalFilters: false ,upsertGoalFilters: false,exception: action.errorMessage };
      default:
        return state;
    }
  }
