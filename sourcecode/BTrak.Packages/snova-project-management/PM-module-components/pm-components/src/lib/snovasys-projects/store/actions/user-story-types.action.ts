...
export enum UserStoryTypesActionTypes {
  LoadUserStoryTypesTriggered = "[Snovasys-PM][UserStoryTypes Component] Initial Data Load Triggered",
  LoadUserStoryTypesCompleted = "[Snovasys-PM][UserStoryTypes Component] Initial Data Load Completed",
  LoadUserStoryTypesFailed = "[Snovasys-PM][UserStoryTypes Component] Initial Data Load Failed"
}
