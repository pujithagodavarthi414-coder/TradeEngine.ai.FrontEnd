...
export function reducer(
  ...
  switch (action.type) {
    ...
    case workFlowStatusActionTypes.LoadWorkflowStatusListTriggered:
        return { ...initialState, loadingWorkflowstatus: true };
    case workFlowStatusActionTypes.LoadworkflowStatusCompleted:
      return workflowStatusAdapter.addAll(action.workflowStatus, {
        ...state,
        loadingWorkflowstatus: false
      });
