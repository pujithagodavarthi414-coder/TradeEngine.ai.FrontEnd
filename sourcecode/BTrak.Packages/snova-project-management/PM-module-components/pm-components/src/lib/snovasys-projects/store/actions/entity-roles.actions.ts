...
export enum EntityRoleActionTypes {
  LoadEntityRolesTriggered = "[Snovasys-PM][EntityRole Component] Initial Data Load Triggered",
  LoadEntityRolesCompleted = "[Snovasys-PM][EntityRole Component] Initial Data Load Completed",
  LoadEntityRolesCompletedFromCache = "[Snovasys-PM][EntityRole Component] Initial Data Load Completed From Cache"
}
