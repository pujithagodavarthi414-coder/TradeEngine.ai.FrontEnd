...
export enum RoleActionTypes {
  LoadRolesTriggered = "[Snovasys-PM][Role Component] Initial Data Load Triggered",
  LoadRolesCompleted = "[Snovasys-PM][Role Component] Initial Data Load Completed",
  LoadRolesCompletedFromCache = "[Snovasys-PM][Role Component] Initial Data Load Completed From Cache"
}
