...
export enum BugPriorityActionTypes {
  LoadBugPriorityTypesTriggered = "[Snovasys-PM][BugPriorityTypes Component] Initial Data Load Triggered",
  LoadBugPriorityTypesCompleted = "[Snovasys-PM][BugPriorityTypes Component] Initial Data Load Completed",
  LoadBugPriorityTypesFailed = "[Snovasys-PM][BugPriorityTypes Component] Initial Data Load Failed",
  LoadBugPriorityTypesFromCache = "[Snovasys-PM][BugPriorityTypes Component] Initial Data Load Completed From Cache"
}
