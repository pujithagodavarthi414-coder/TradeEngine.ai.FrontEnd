...
@Component({
  selector: "app-common-userstoryRemainingTime",
  templateUrl: "./remainingEstimate.component.html",
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RemainingSpentTimeComponent implements OnInit {
  ...
  @Output() totalEstimatedSpentTimeInHours = new EventEmitter<any>();
  ...
  reducedSpentTimeFormControl = new FormControl("", {
  ...
  constructor(private toastr: ToastrService,
    ...
    private cdRef: ChangeDetectorRef) {
      ...
      .pipe(
        ...
        tap(() => {
          this.spentTime = null;
          this.reducedSpentTimeFormControl.reset();
        })
      )
      .subscribe();
  ...
  saveReducedEstimatedTime() {
    if (this.reducedSpentTimeFormControl.valid) {
      ...
      if (this.estimatedTimeInHours > 160) {
        ...
        this.totalEstimatedSpentTimeInHours.emit(null);
      }
      else if (this.estimatedTimeInHours > 0) {
        this.totalEstimatedSpentTimeInHours.emit(this.estimatedTimeInHours);
