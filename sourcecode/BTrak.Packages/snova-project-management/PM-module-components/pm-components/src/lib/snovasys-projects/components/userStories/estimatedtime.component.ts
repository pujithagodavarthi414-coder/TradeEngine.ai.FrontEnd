...
@Component({
  selector: "app-common-estimatedTime",
  templateUrl: "./estimatedtime.component.html",
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EstimatedTimeComponent implements OnInit {

  estimatedTime;
  isGoalPage: boolean = false;
  @Input("estimatedTime")
  ...
  @Input("isGoalPage")
  set _isGoalPage(data: boolean) {
    this.isGoalPage = data;
  }
  ...
  saveEstimatedTime() {
    if (this.estimatedTimeFormControl.valid) {
      ...
      if (this.estimatedTimeInHours > 99 && !this.isGoalPage) {
