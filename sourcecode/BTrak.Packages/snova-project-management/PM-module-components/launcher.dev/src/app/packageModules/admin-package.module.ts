...
export class AdminComponentSupplierService {
    ...
    static components = [
        ...
        {
            name: "Workflow status component",
            componentTypeObject: WorkFlowManagementComponent
        },
        {
            name: "Workflow status transition component",
            componentTypeObject: WorkFlowStatusTransitionComponent
        },
        {
            name: "Bug priority",
