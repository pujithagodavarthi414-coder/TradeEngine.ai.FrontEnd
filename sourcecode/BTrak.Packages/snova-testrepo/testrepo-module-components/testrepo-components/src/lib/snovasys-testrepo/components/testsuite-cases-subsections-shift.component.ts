...
@Component({
    selector: "testsuite-cases-subsections-shift",
    templateUrl: "./testsuite-cases-subsections-shift.component.html",
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class TestSuiteCasesSubSectionsShiftComponent {
