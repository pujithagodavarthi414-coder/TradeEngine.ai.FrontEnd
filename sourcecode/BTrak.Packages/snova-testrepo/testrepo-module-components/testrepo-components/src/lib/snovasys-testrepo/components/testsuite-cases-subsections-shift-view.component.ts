...
@Component({
    selector: "testsuite-cases-subsections-shift-view",
    templateUrl: "./testsuite-cases-subsections-shift-view.component.html",
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class TestSuiteCasesSubSectionsShiftViewComponent {
